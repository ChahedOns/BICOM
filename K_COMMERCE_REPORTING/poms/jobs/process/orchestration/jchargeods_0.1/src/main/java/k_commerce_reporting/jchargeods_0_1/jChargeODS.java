...
package k_commerce_reporting.jchargeods_0_1;
...
public class jChargeODS implements TalendJob {
	...
	public static class row_Implicit_Context_DatabaseStruct
		...
		final static byte[] commonByteArrayLock_K_COMMERCE_REPORTING_jChargeODS = new byte[0];
		static byte[] commonByteArray_K_COMMERCE_REPORTING_jChargeODS = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_K_COMMERCE_REPORTING_jChargeODS.length) {
					if (length < 1024 && commonByteArray_K_COMMERCE_REPORTING_jChargeODS.length == 0) {
						commonByteArray_K_COMMERCE_REPORTING_jChargeODS = new byte[1024];
					} else {
						commonByteArray_K_COMMERCE_REPORTING_jChargeODS = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_K_COMMERCE_REPORTING_jChargeODS, 0, length);
				strReturn = new String(commonByteArray_K_COMMERCE_REPORTING_jChargeODS, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_K_COMMERCE_REPORTING_jChargeODS, 0, length);
				strReturn = new String(commonByteArray_K_COMMERCE_REPORTING_jChargeODS, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_K_COMMERCE_REPORTING_jChargeODS) {
					...
					while (rs_Implicit_Context_Database.next()) {
						...
						if (tmp_key_Implicit_Context_Context != null) {
							try {
								...
								if (key_Implicit_Context_Context != null
										&& "fieldSeparator".equals(key_Implicit_Context_Context)) {
	...
	public void tJava_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				System.out.println("Debut du ODS! \n ");
				System.out.println("Connexion a la base de données OK!");
				System.out.println("---------------------------------------- \n");
				System.out.println(
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				k_commerce_reporting.jodscategorie_0_1.jODSCategorie childJob_tRunJob_1 = new k_commerce_reporting.jodscategorie_0_1.jODSCategorie();
				// pass DataSources
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				class ContextProcessor_tRunJob_2 {
					private void transmitContext_0() {
						...
						paraList_tRunJob_2.add("--context_type " + "user" + "=" + "id_String");
				...
				k_commerce_reporting.jodssouscategorie_0_1.jODSSousCategorie childJob_tRunJob_2 = new k_commerce_reporting.jodssouscategorie_0_1.jODSSousCategorie();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				k_commerce_reporting.jodsproduit_0_1.jODSProduit childJob_tRunJob_3 = new k_commerce_reporting.jodsproduit_0_1.jODSProduit();
				// pass DataSources
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				k_commerce_reporting.jodstypeclient_0_1.jODSTypeClient childJob_tRunJob_4 = new k_commerce_reporting.jodstypeclient_0_1.jODSTypeClient();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				k_commerce_reporting.jodsclient_0_1.jODSClient childJob_tRunJob_5 = new k_commerce_reporting.jodsclient_0_1.jODSClient();
				// pass DataSources
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				class ContextProcessor_tRunJob_6 {
					private void transmitContext_0() {
						...
						parentContextMap_tRunJob_6.put("user", context.user);
						paraList_tRunJob_6.add("--context_type " + "user" + "=" + "id_String");
				...
				k_commerce_reporting.jodsvente_0_1.jODSVente childJob_tRunJob_6 = new k_commerce_reporting.jodsvente_0_1.jODSVente();
				// pass DataSources
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = jChargeODS.class.getClassLoader()
					.getResourceAsStream("k_commerce_reporting/jchargeods_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = jChargeODS.class.getClassLoader()
...
/************************************************************************************************
 * 146383 characters generated by Talend Open Studio for Data Integration on the
 * 18 novembre 2023 à 12:13:28 AM CET
 ************************************************************************************************/