...
package k_commerce_reporting.jdwhclient_0_1;
...
/**
 * Job: jDWHClient Purpose: alimentation de la table Client<br>
 * Description: alimentation de la table Client <br>
...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_K_COMMERCE_REPORTING_jDWHClient = new byte[0];
    static byte[] commonByteArray_K_COMMERCE_REPORTING_jDWHClient = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_K_COMMERCE_REPORTING_jDWHClient.length) {
				if(length < 1024 && commonByteArray_K_COMMERCE_REPORTING_jDWHClient.length == 0) {
   					commonByteArray_K_COMMERCE_REPORTING_jDWHClient = new byte[1024];
				} else {
   					commonByteArray_K_COMMERCE_REPORTING_jDWHClient = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_K_COMMERCE_REPORTING_jDWHClient, 0, length);
			strReturn = new String(commonByteArray_K_COMMERCE_REPORTING_jDWHClient, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_K_COMMERCE_REPORTING_jDWHClient, 0, length);
			strReturn = new String(commonByteArray_K_COMMERCE_REPORTING_jDWHClient, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_K_COMMERCE_REPORTING_jDWHClient) {
...
if(dbschema_tDBOutput_3 == null || dbschema_tDBOutput_3.trim().length() == 0) {
	...
	tableName_tDBOutput_3 = dbschema_tDBOutput_3 + "\".\"" + ("DIM_CLIENT");
        ...
        } else if (updateKeyCount_tDBOutput_3 == 14 && true) {        
...
int count_tDBOutput_3=0;
	    String update_tDBOutput_3 = "UPDATE \"" + tableName_tDBOutput_3 + "\" SET \"ID_CLIENT\" = ?,\"NOM_CLIENT\" = ?,\"PREN_CLIENT\" = ?,\"CD_POSTAL_CLIENT\" = ?,\"VILLE_CLIENT\" = ?,\"PAYS_CLIENT\" = ?,\"REGION_CLIENT\" = ?,\"CD_TYPE_CLIENT\" = ?,\"LB_TYPE_CLIENT\" = ?,\"DT_INSERTION\" = ?,\"DT_MISE_A_JOUR\" = ?,\"BL_LIGNE_ACTIVE\" = ?,\"LB_JOB_NAME\" = ? WHERE \"ID_DIM_CLIENT\" = ?";
...
int count_tDBOutput_2=0;
	    String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2 + "\" (\"ID_CLIENT\",\"NOM_CLIENT\",\"PREN_CLIENT\",\"CD_POSTAL_CLIENT\",\"VILLE_CLIENT\",\"PAYS_CLIENT\",\"REGION_CLIENT\",\"CD_TYPE_CLIENT\",\"LB_TYPE_CLIENT\",\"DT_INSERTION\",\"DT_MISE_A_JOUR\",\"BL_LIGNE_ACTIVE\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
updateClient_tmp.ID_DIM_CLIENT = row3.ID_DIM_CLIENT ;
updateClient_tmp.ID_CLIENT = clients.ID_CLIENT ;
updateClient_tmp.NOM_CLIENT = clients.NOM_CLIENT ;
updateClient_tmp.PREN_CLIENT = clients.PREN_CLIENT ;
updateClient_tmp.CD_POSTAL_CLIENT = clients.CD_POSTAL_CLIENT ;
updateClient_tmp.VILLE_CLIENT = clients.VILLE_CLIENT ;
updateClient_tmp.PAYS_CLIENT = clients.PAYS_CLIENT ;
updateClient_tmp.REGION_CLIENT = clients.REGION_CLIENT ;
updateClient_tmp.CD_TYPE_CLIENT = clients.CD_TYPE_CLIENT ;
updateClient_tmp.LB_TYPE_CLIENT = clients.LB_TYPE_CLIENT ;
updateClient_tmp.DT_INSERTION = row3.DT_INSERTION ;
updateClient_tmp.DT_MISE_A_JOUR = TalendDate.getCurrentDate();
updateClient_tmp.BL_LIGNE_ACTIVE = 0;
updateClient_tmp.LB_JOB_NAME = row3.LB_JOB_NAME ;
...
insertNewClient_tmp.LB_TYPE_CLIENT = clients.LB_TYPE_CLIENT  ;
insertNewClient_tmp.DT_INSERTION = TalendDate.getCurrentDate() ;
insertNewClient_tmp.DT_MISE_A_JOUR = null;
insertNewClient_tmp.BL_LIGNE_ACTIVE = 1 ;
insertNewClient_tmp.LB_JOB_NAME = clients.LB_JOB_NAME  ;
...
} else {pstmt_tDBOutput_3.setString(1, updateClient.ID_CLIENT);
}

                    if(updateClient.NOM_CLIENT == null) {
pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(2, updateClient.NOM_CLIENT);
}

                    if(updateClient.PREN_CLIENT == null) {
pstmt_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(3, updateClient.PREN_CLIENT);
}

                    if(updateClient.CD_POSTAL_CLIENT == null) {
pstmt_tDBOutput_3.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(4, updateClient.CD_POSTAL_CLIENT);
}

                    if(updateClient.VILLE_CLIENT == null) {
pstmt_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(5, updateClient.VILLE_CLIENT);
}

                    if(updateClient.PAYS_CLIENT == null) {
pstmt_tDBOutput_3.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(6, updateClient.PAYS_CLIENT);
}

                    if(updateClient.REGION_CLIENT == null) {
pstmt_tDBOutput_3.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(7, updateClient.REGION_CLIENT);
}

                    if(updateClient.CD_TYPE_CLIENT == null) {
pstmt_tDBOutput_3.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(8, updateClient.CD_TYPE_CLIENT);
}

                    if(updateClient.LB_TYPE_CLIENT == null) {
pstmt_tDBOutput_3.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(9, updateClient.LB_TYPE_CLIENT);
}

                    if(updateClient.DT_INSERTION != null) {
pstmt_tDBOutput_3.setTimestamp(10, new java.sql.Timestamp(updateClient.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_3.setNull(10, java.sql.Types.TIMESTAMP);
}

                    if(updateClient.DT_MISE_A_JOUR != null) {
pstmt_tDBOutput_3.setTimestamp(11, new java.sql.Timestamp(updateClient.DT_MISE_A_JOUR.getTime()));
} else {
pstmt_tDBOutput_3.setNull(11, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_3.setInt(12, updateClient.BL_LIGNE_ACTIVE);

                    if(updateClient.LB_JOB_NAME == null) {
pstmt_tDBOutput_3.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(13, updateClient.LB_JOB_NAME);
}

                    pstmt_tDBOutput_3.setInt(14 + count_tDBOutput_3, updateClient.ID_DIM_CLIENT);
...
pstmt_tDBOutput_2.setNull(8, java.sql.Types.VARCHAR);
                    ...
                    if(insertNewClient.LB_TYPE_CLIENT == null) {
pstmt_tDBOutput_2.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(9, insertNewClient.LB_TYPE_CLIENT);
}
...
pstmt_tDBOutput_2.setNull(10, java.sql.Types.TIMESTAMP);
                    ...
                    if(insertNewClient.DT_MISE_A_JOUR != null) {
pstmt_tDBOutput_2.setTimestamp(11, new java.sql.Timestamp(insertNewClient.DT_MISE_A_JOUR.getTime()));
} else {
pstmt_tDBOutput_2.setNull(11, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_2.setInt(12, insertNewClient.BL_LIGNE_ACTIVE);

                    if(insertNewClient.LB_JOB_NAME == null) {
pstmt_tDBOutput_2.setNull(13, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(13, insertNewClient.LB_JOB_NAME);
}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row3";
		...
		int tos_count_tAdvancedHash_row3 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(clients,row3) outputs:(insertClient,updateClient,insertNewClient)
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jDWHClient.class.getClassLoader().getResourceAsStream("k_commerce_reporting/jdwhclient_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     264553 characters generated by Talend Open Studio for Data Integration 
 *     on the 17 novembre 2023 à 11:51:10 PM CET
 ************************************************************************************************/