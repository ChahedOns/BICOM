...
package k_commerce_reporting.jgeneratecalendar_0_2;
...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_K_COMMERCE_REPORTING_jGenerateCalendar = new byte[0];
    static byte[] commonByteArray_K_COMMERCE_REPORTING_jGenerateCalendar = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_K_COMMERCE_REPORTING_jGenerateCalendar.length) {
				if(length < 1024 && commonByteArray_K_COMMERCE_REPORTING_jGenerateCalendar.length == 0) {
   					commonByteArray_K_COMMERCE_REPORTING_jGenerateCalendar = new byte[1024];
				} else {
   					commonByteArray_K_COMMERCE_REPORTING_jGenerateCalendar = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_K_COMMERCE_REPORTING_jGenerateCalendar, 0, length);
			strReturn = new String(commonByteArray_K_COMMERCE_REPORTING_jGenerateCalendar, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_K_COMMERCE_REPORTING_jGenerateCalendar, 0, length);
			strReturn = new String(commonByteArray_K_COMMERCE_REPORTING_jGenerateCalendar, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_K_COMMERCE_REPORTING_jGenerateCalendar) {
 ...
 */
	...
	final String decryptedPassword_tFileInputExcel_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:vRFGdwZp5U35gbx2EtHYj60aYJeVXzR3d4+dhw==");
		...
		Object source_tFileInputExcel_1 = "D:/workspace/formationtalend/Section 10/Mini Projet1 Partie2/joursFeries.xlsx";
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jGenerateCalendar.class.getClassLoader().getResourceAsStream("k_commerce_reporting/jgeneratecalendar_0_2/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     179628 characters generated by Talend Open Studio for Data Integration 
 *     on the 17 novembre 2023 à 11:51:22 PM CET
 ************************************************************************************************/