...
package k_commerce_reporting.jodssouscategorie_0_1;
...
/**
 * Job: jODSSousCategorie Purpose: jODSSousCategorie<br>
 * Description: jODSSousCategorie <br>
...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_K_COMMERCE_REPORTING_jODSSousCategorie = new byte[0];
    static byte[] commonByteArray_K_COMMERCE_REPORTING_jODSSousCategorie = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_K_COMMERCE_REPORTING_jODSSousCategorie.length) {
				if(length < 1024 && commonByteArray_K_COMMERCE_REPORTING_jODSSousCategorie.length == 0) {
   					commonByteArray_K_COMMERCE_REPORTING_jODSSousCategorie = new byte[1024];
				} else {
   					commonByteArray_K_COMMERCE_REPORTING_jODSSousCategorie = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_K_COMMERCE_REPORTING_jODSSousCategorie, 0, length);
			strReturn = new String(commonByteArray_K_COMMERCE_REPORTING_jODSSousCategorie, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_K_COMMERCE_REPORTING_jODSSousCategorie, 0, length);
			strReturn = new String(commonByteArray_K_COMMERCE_REPORTING_jODSSousCategorie, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_K_COMMERCE_REPORTING_jODSSousCategorie) {
...
public static class InsertNewSousCategorieStruct implements routines.system.IPersistableRow<InsertNewSousCategorieStruct> {
    final static byte[] commonByteArrayLock_K_COMMERCE_REPORTING_jODSSousCategorie = new byte[0];
    static byte[] commonByteArray_K_COMMERCE_REPORTING_jODSSousCategorie = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
...
public static class updateSousCategorieStruct implements routines.system.IPersistableRow<updateSousCategorieStruct> {
    final static byte[] commonByteArrayLock_K_COMMERCE_REPORTING_jODSSousCategorie = new byte[0];
    static byte[] commonByteArray_K_COMMERCE_REPORTING_jODSSousCategorie = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final updateSousCategorieStruct other = (updateSousCategorieStruct) obj;
	...
	public void copyDataTo(updateSousCategorieStruct other) {
	...
	public void copyKeysDataTo(updateSousCategorieStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(updateSousCategorieStruct other) {
...
public static class categorieManquanteStruct implements routines.system.IPersistableRow<categorieManquanteStruct> {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final categorieManquanteStruct other = (categorieManquanteStruct) obj;
	...
	public void copyDataTo(categorieManquanteStruct other) {
	...
	public void copyKeysDataTo(categorieManquanteStruct other) {
...
updateSousCategorieStruct updateSousCategorie = new updateSousCategorieStruct();
...
int count_tDBOutput_1=0;
	    String insert_tDBOutput_1 = "INSERT INTO \"" + tableName_tDBOutput_1 + "\" (\"CD_SOUS_CATEGORIE\",\"LB_SOUS_CATEGORIE\",\"CD_CATEGORIE\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"BL_LIGNE_ACTIVE\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?,?)";
...
int count_tDBOutput_2=0;
	    java.sql.PreparedStatement pstmt_tDBOutput_2 = conn_tDBOutput_2.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_2 + "\" WHERE \"CD_SOUS_CATEGORIE\" = ?");
	    ...
	    String update_tDBOutput_2 = "UPDATE \"" + tableName_tDBOutput_2 + "\" SET \"LB_SOUS_CATEGORIE\" = ?,\"CD_CATEGORIE\" = ?,\"LB_NOM_FICHIER\" = ?,\"DT_INSERTION\" = ?,\"BL_LIGNE_ACTIVE\" = ?,\"LB_JOB_NAME\" = ? WHERE \"CD_SOUS_CATEGORIE\" = ?";
 ...
 */
	...
	currentComponent="tDBOutput_5";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"updateSousCategorie");
					}
...
if(dbschema_tDBOutput_5 == null || dbschema_tDBOutput_5.trim().length() == 0) {
	tableName_tDBOutput_5 = ("ODS_SOUS_CATEGORIE");
} else {
	tableName_tDBOutput_5 = dbschema_tDBOutput_5 + "\".\"" + ("ODS_SOUS_CATEGORIE");
}
...
int count_tDBOutput_5=0;
	    java.sql.PreparedStatement pstmt_tDBOutput_5 = conn_tDBOutput_5.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_5 + "\" WHERE \"CD_SOUS_CATEGORIE\" = ?");
	    resourceMap.put("pstmt_tDBOutput_5", pstmt_tDBOutput_5);
	    String insert_tDBOutput_5 = "INSERT INTO \"" + tableName_tDBOutput_5 + "\" (\"CD_SOUS_CATEGORIE\",\"LB_SOUS_CATEGORIE\",\"CD_CATEGORIE\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"BL_LIGNE_ACTIVE\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?,?)";
	    ...
	    String update_tDBOutput_5 = "UPDATE \"" + tableName_tDBOutput_5 + "\" SET \"LB_SOUS_CATEGORIE\" = ?,\"CD_CATEGORIE\" = ?,\"LB_NOM_FICHIER\" = ?,\"DT_INSERTION\" = ?,\"BL_LIGNE_ACTIVE\" = ?,\"LB_JOB_NAME\" = ? WHERE \"CD_SOUS_CATEGORIE\" = ?";
...
updateSousCategorieStruct updateSousCategorie_tmp = new updateSousCategorieStruct();
// ###############################
...
SousCategorie_tmp.CD_SOUS_CATEGORIE = row1.CD_SOUS_CATEGORIE ;
SousCategorie_tmp.LB_SOUS_CATEGORIE = row1.LB_SOUS_CATEGORIE ;
SousCategorie_tmp.CD_CATEGORIE = row1.CD_CATEGORIE ;
SousCategorie_tmp.NUM_LIGNE = Numeric.sequence("s1",1,1) ;
...
if(SousCategorie != null) { 
    ...
    Operator_tFilterRow_1 ope_tFilterRow_1 = new Operator_tFilterRow_1("&&");
      ope_tFilterRow_1.matches((// code sample : use SousCategorie to define the condition.
// SousCategorie.columnName1.equals("foo") ||!(SousCategorie.columnName2.equals("bar"))
// replace the following expression by your own filter condition 
!SousCategorie.CD_SOUS_CATEGORIE.isEmpty()&& !SousCategorie.LB_SOUS_CATEGORIE.isEmpty() &&  !SousCategorie.CD_CATEGORIE.isEmpty()
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(row2 == null){ 
               ...
               row2.CD_SOUS_CATEGORIE = SousCategorie.CD_SOUS_CATEGORIE;
               row2.LB_SOUS_CATEGORIE = SousCategorie.LB_SOUS_CATEGORIE;
               row2.CD_CATEGORIE = SousCategorie.CD_CATEGORIE;
               row2.NUM_LIGNE = SousCategorie.NUM_LIGNE;    
      nb_line_ok_tFilterRow_1++;
    } else {
            if (row5 == null){
              row5 = new row5Struct();
            }
                row5.CD_SOUS_CATEGORIE = SousCategorie.CD_SOUS_CATEGORIE;
                row5.LB_SOUS_CATEGORIE = SousCategorie.LB_SOUS_CATEGORIE;
                row5.CD_CATEGORIE = SousCategorie.CD_CATEGORIE;
                row5.NUM_LIGNE = SousCategorie.NUM_LIGNE;
...
sousCategories_tmp.CD_SOUS_CATEGORIE = row3.CD_SOUS_CATEGORIE ;
sousCategories_tmp.LB_SOUS_CATEGORIE = row3.LB_SOUS_CATEGORIE ;
sousCategories_tmp.CD_CATEGORIE = row3.CD_CATEGORIE ;
sousCategories_tmp.NUM_LIGNE = row3.NUM_LIGNE ;
...
categorieManquante_tmp.LB_LIGNE_REJET = row3.CD_SOUS_CATEGORIE+"|"+row3.LB_SOUS_CATEGORIE ;
categorieManquante_tmp.LB_MESSAGE_REJET = "Categorie Maquante!";
 					    ...
 					    boolean forceLooprow4 = false;
 							...
 							row4Struct row4ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
                        		    		    ...
                        		    		    row4HashKey.CD_SOUS_CATEGORIE = sousCategories.CD_SOUS_CATEGORIE ;
...
updateSousCategorie = null;
insertSousCategorie = null;

if(!rejectedInnerJoin_tMap_2 ) {

// # Output table : 'InsertNewSousCategorie'
// # Filter conditions 
if( 

!  sousCategories.LB_SOUS_CATEGORIE  .equals(  row4.LB_SOUS_CATEGORIE ) || ! sousCategories.CD_CATEGORIE.equals(row4.CD_CATEGORIE)

 ) {
InsertNewSousCategorie_tmp.CD_SOUS_CATEGORIE = sousCategories.CD_SOUS_CATEGORIE ;
InsertNewSousCategorie_tmp.LB_SOUS_CATEGORIE = sousCategories.LB_SOUS_CATEGORIE ;
InsertNewSousCategorie_tmp.CD_CATEGORIE = sousCategories.CD_CATEGORIE ;
InsertNewSousCategorie_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
...
// # Output table : 'updateSousCategorie'
// # Filter conditions 
if( 
...
updateSousCategorie_tmp.CD_SOUS_CATEGORIE = sousCategories.CD_SOUS_CATEGORIE ;
updateSousCategorie_tmp.LB_SOUS_CATEGORIE = null;
updateSousCategorie_tmp.CD_CATEGORIE = null;
updateSousCategorie_tmp.LB_NOM_FICHIER = null;
updateSousCategorie_tmp.DT_INSERTION = null;
updateSousCategorie_tmp.BL_LIGNE_ACTIVE = 0;
updateSousCategorie_tmp.LB_JOB_NAME = null;
updateSousCategorie = updateSousCategorie_tmp;
} // closing filter/reject
} // closing inner join bracket (1)
// ###### START REJECTS ##### 
...
// # Filter conditions 
if( rejectedInnerJoin_tMap_2 ) {
insertSousCategorie_tmp.CD_SOUS_CATEGORIE = sousCategories.CD_SOUS_CATEGORIE ;
insertSousCategorie_tmp.LB_SOUS_CATEGORIE = sousCategories.LB_SOUS_CATEGORIE ;
insertSousCategorie_tmp.CD_CATEGORIE = sousCategories.CD_CATEGORIE ;
...
} else {pstmt_tDBOutput_1.setString(1, insertSousCategorie.CD_SOUS_CATEGORIE);
}

                    if(insertSousCategorie.LB_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(2, insertSousCategorie.LB_SOUS_CATEGORIE);
}

                    if(insertSousCategorie.CD_CATEGORIE == null) {
pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(3, insertSousCategorie.CD_CATEGORIE);
}

                    if(insertSousCategorie.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(4, insertSousCategorie.LB_NOM_FICHIER);
}

                    if(insertSousCategorie.DT_INSERTION != null) {
pstmt_tDBOutput_1.setTimestamp(5, new java.sql.Timestamp(insertSousCategorie.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_1.setNull(5, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_1.setInt(6, insertSousCategorie.BL_LIGNE_ACTIVE);

                    if(insertSousCategorie.LB_JOB_NAME == null) {
pstmt_tDBOutput_1.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_1.setString(7, insertSousCategorie.LB_JOB_NAME);
}
...
} else {pstmt_tDBOutput_2.setString(1, InsertNewSousCategorie.CD_SOUS_CATEGORIE);
}
...
} else {pstmtUpdate_tDBOutput_2.setString(1, InsertNewSousCategorie.LB_SOUS_CATEGORIE);
}

                        if(InsertNewSousCategorie.CD_CATEGORIE == null) {
pstmtUpdate_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(2, InsertNewSousCategorie.CD_CATEGORIE);
}

                        if(InsertNewSousCategorie.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(3, InsertNewSousCategorie.LB_NOM_FICHIER);
}

                        if(InsertNewSousCategorie.DT_INSERTION != null) {
pstmtUpdate_tDBOutput_2.setTimestamp(4, new java.sql.Timestamp(InsertNewSousCategorie.DT_INSERTION.getTime()));
} else {
pstmtUpdate_tDBOutput_2.setNull(4, java.sql.Types.TIMESTAMP);
}

                        pstmtUpdate_tDBOutput_2.setInt(5, InsertNewSousCategorie.BL_LIGNE_ACTIVE);

                        if(InsertNewSousCategorie.LB_JOB_NAME == null) {
pstmtUpdate_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(6, InsertNewSousCategorie.LB_JOB_NAME);
}

                        if(InsertNewSousCategorie.CD_SOUS_CATEGORIE == null) {
pstmtUpdate_tDBOutput_2.setNull(7 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(7 + count_tDBOutput_2, InsertNewSousCategorie.CD_SOUS_CATEGORIE);
}
...
} else {pstmtInsert_tDBOutput_2.setString(1, InsertNewSousCategorie.CD_SOUS_CATEGORIE);
}

                        if(InsertNewSousCategorie.LB_SOUS_CATEGORIE == null) {
pstmtInsert_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(2, InsertNewSousCategorie.LB_SOUS_CATEGORIE);
}

                        if(InsertNewSousCategorie.CD_CATEGORIE == null) {
pstmtInsert_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(3, InsertNewSousCategorie.CD_CATEGORIE);
}

                        if(InsertNewSousCategorie.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(4, InsertNewSousCategorie.LB_NOM_FICHIER);
}

                        if(InsertNewSousCategorie.DT_INSERTION != null) {
pstmtInsert_tDBOutput_2.setTimestamp(5, new java.sql.Timestamp(InsertNewSousCategorie.DT_INSERTION.getTime()));
} else {
pstmtInsert_tDBOutput_2.setNull(5, java.sql.Types.TIMESTAMP);
}

                        pstmtInsert_tDBOutput_2.setInt(6, InsertNewSousCategorie.BL_LIGNE_ACTIVE);

                        if(InsertNewSousCategorie.LB_JOB_NAME == null) {
pstmtInsert_tDBOutput_2.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(7, InsertNewSousCategorie.LB_JOB_NAME);
}
...
// Start of branch "updateSousCategorie"
if(updateSousCategorie != null) { 
	...
	currentComponent="tDBOutput_5";
        ...
        whetherReject_tDBOutput_5 = false;
                    if(updateSousCategorie.CD_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_5.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(1, updateSousCategorie.CD_SOUS_CATEGORIE);
}
            ...
            if(checkCount_tDBOutput_5 > 0) {
                        if(updateSousCategorie.LB_SOUS_CATEGORIE == null) {
pstmtUpdate_tDBOutput_5.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_5.setString(1, updateSousCategorie.LB_SOUS_CATEGORIE);
}

                        if(updateSousCategorie.CD_CATEGORIE == null) {
pstmtUpdate_tDBOutput_5.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_5.setString(2, updateSousCategorie.CD_CATEGORIE);
}

                        if(updateSousCategorie.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_5.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_5.setString(3, updateSousCategorie.LB_NOM_FICHIER);
}

                        if(updateSousCategorie.DT_INSERTION != null) {
pstmtUpdate_tDBOutput_5.setTimestamp(4, new java.sql.Timestamp(updateSousCategorie.DT_INSERTION.getTime()));
} else {
pstmtUpdate_tDBOutput_5.setNull(4, java.sql.Types.TIMESTAMP);
}

                        pstmtUpdate_tDBOutput_5.setInt(5, updateSousCategorie.BL_LIGNE_ACTIVE);

                        if(updateSousCategorie.LB_JOB_NAME == null) {
pstmtUpdate_tDBOutput_5.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_5.setString(6, updateSousCategorie.LB_JOB_NAME);
}

                        if(updateSousCategorie.CD_SOUS_CATEGORIE == null) {
pstmtUpdate_tDBOutput_5.setNull(7 + count_tDBOutput_5, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_5.setString(7 + count_tDBOutput_5, updateSousCategorie.CD_SOUS_CATEGORIE);
}
...
} else {pstmtInsert_tDBOutput_5.setString(1, updateSousCategorie.CD_SOUS_CATEGORIE);
}

                        if(updateSousCategorie.LB_SOUS_CATEGORIE == null) {
pstmtInsert_tDBOutput_5.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_5.setString(2, updateSousCategorie.LB_SOUS_CATEGORIE);
}

                        if(updateSousCategorie.CD_CATEGORIE == null) {
pstmtInsert_tDBOutput_5.setNull(3, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_5.setString(3, updateSousCategorie.CD_CATEGORIE);
}

                        if(updateSousCategorie.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_5.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_5.setString(4, updateSousCategorie.LB_NOM_FICHIER);
}

                        if(updateSousCategorie.DT_INSERTION != null) {
pstmtInsert_tDBOutput_5.setTimestamp(5, new java.sql.Timestamp(updateSousCategorie.DT_INSERTION.getTime()));
} else {
pstmtInsert_tDBOutput_5.setNull(5, java.sql.Types.TIMESTAMP);
}

                        pstmtInsert_tDBOutput_5.setInt(6, updateSousCategorie.BL_LIGNE_ACTIVE);

                        if(updateSousCategorie.LB_JOB_NAME == null) {
pstmtInsert_tDBOutput_5.setNull(7, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_5.setString(7, updateSousCategorie.LB_JOB_NAME);
}
...
} // End of branch "updateSousCategorie"
...
} else {pstmtUpdate_tDBOutput_6.setString(1, categorieManquante.LB_MESSAGE_REJET);
}

                        if(categorieManquante.LB_NOM_FLUX == null) {
pstmtUpdate_tDBOutput_6.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_6.setString(2, categorieManquante.LB_NOM_FLUX);
}

                        if(categorieManquante.DT_REJET != null) {
pstmtUpdate_tDBOutput_6.setTimestamp(3, new java.sql.Timestamp(categorieManquante.DT_REJET.getTime()));
} else {
...
} else {pstmtUpdate_tDBOutput_6.setString(4, categorieManquante.LB_JOB_NAME);
}

                        if(categorieManquante.LB_CHEMIN_FICHIER == null) {
pstmtUpdate_tDBOutput_6.setNull(5 + count_tDBOutput_6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_6.setString(5 + count_tDBOutput_6, categorieManquante.LB_CHEMIN_FICHIER);
}

                        if(categorieManquante.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_6.setNull(6 + count_tDBOutput_6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_6.setString(6 + count_tDBOutput_6, categorieManquante.LB_NOM_FICHIER);
}

                        pstmtUpdate_tDBOutput_6.setInt(7 + count_tDBOutput_6, categorieManquante.NUM_LIGNE_REJET);

                        if(categorieManquante.LB_LIGNE_REJET == null) {
pstmtUpdate_tDBOutput_6.setNull(8 + count_tDBOutput_6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_6.setString(8 + count_tDBOutput_6, categorieManquante.LB_LIGNE_REJET);
}
...
} else {pstmtInsert_tDBOutput_6.setString(1, categorieManquante.LB_CHEMIN_FICHIER);
}

                        if(categorieManquante.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_6.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_6.setString(2, categorieManquante.LB_NOM_FICHIER);
}

                        pstmtInsert_tDBOutput_6.setInt(3, categorieManquante.NUM_LIGNE_REJET);

                        if(categorieManquante.LB_LIGNE_REJET == null) {
pstmtInsert_tDBOutput_6.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_6.setString(4, categorieManquante.LB_LIGNE_REJET);
}

                        if(categorieManquante.LB_MESSAGE_REJET == null) {
pstmtInsert_tDBOutput_6.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_6.setString(5, categorieManquante.LB_MESSAGE_REJET);
}

                        if(categorieManquante.LB_NOM_FLUX == null) {
pstmtInsert_tDBOutput_6.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_6.setString(6, categorieManquante.LB_NOM_FLUX);
}

                        if(categorieManquante.DT_REJET != null) {
pstmtInsert_tDBOutput_6.setTimestamp(7, new java.sql.Timestamp(categorieManquante.DT_REJET.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_6.setString(8, categorieManquante.LB_JOB_NAME);
}
 ...
 */
	...
	nb_line_rejected_tDBOutput_5=nb_line_rejected_tDBOutput_5 + rejectedCount_tDBOutput_5;
        ...
        globalMap.put("tDBOutput_5_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_5);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"updateSousCategorie");
			  	}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row7";
		...
		int tos_count_tAdvancedHash_row7 = 0;
			   		...
			   		// linked node: tMap_5 - inputs:(row3,row7) outputs:(sousCategories,categorieManquante)
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(sousCategories,row4) outputs:(insertSousCategorie,InsertNewSousCategorie,updateSousCategorie)
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jODSSousCategorie.class.getClassLoader().getResourceAsStream("k_commerce_reporting/jodssouscategorie_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     399350 characters generated by Talend Open Studio for Data Integration 
