...
package k_commerce_reporting.jodsvente_0_1;
...
/**
 * Job: jODSVente Purpose: jODSVente<br>
 * Description: jODSVente <br>
 * 
...
public class jODSVente implements TalendJob {
	...
	public static class row_Implicit_Context_DatabaseStruct
		...
		final static byte[] commonByteArrayLock_K_COMMERCE_REPORTING_jODSVente = new byte[0];
		static byte[] commonByteArray_K_COMMERCE_REPORTING_jODSVente = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_K_COMMERCE_REPORTING_jODSVente.length) {
					if (length < 1024 && commonByteArray_K_COMMERCE_REPORTING_jODSVente.length == 0) {
						commonByteArray_K_COMMERCE_REPORTING_jODSVente = new byte[1024];
					} else {
						commonByteArray_K_COMMERCE_REPORTING_jODSVente = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_K_COMMERCE_REPORTING_jODSVente, 0, length);
				strReturn = new String(commonByteArray_K_COMMERCE_REPORTING_jODSVente, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_K_COMMERCE_REPORTING_jODSVente, 0, length);
				strReturn = new String(commonByteArray_K_COMMERCE_REPORTING_jODSVente, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_K_COMMERCE_REPORTING_jODSVente) {
	...
	public static class updateVenteStruct implements routines.system.IPersistableRow<updateVenteStruct> {
		final static byte[] commonByteArrayLock_K_COMMERCE_REPORTING_jODSVente = new byte[0];
		static byte[] commonByteArray_K_COMMERCE_REPORTING_jODSVente = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final updateVenteStruct other = (updateVenteStruct) obj;
		...
		public void copyDataTo(updateVenteStruct other) {
		...
		public void copyKeysDataTo(updateVenteStruct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(updateVenteStruct other) {
	...
	public static class produitVenteStruct implements routines.system.IPersistableRow<produitVenteStruct> {
		final static byte[] commonByteArrayLock_K_COMMERCE_REPORTING_jODSVente = new byte[0];
		static byte[] commonByteArray_K_COMMERCE_REPORTING_jODSVente = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(produitVenteStruct other) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				produitVenteStruct produitVente = new produitVenteStruct();
				ventesStruct ventes = new ventesStruct();
				updateVenteStruct updateVente = new updateVenteStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "updateVente");
				}
				...
				if (dbschema_tDBOutput_5 == null || dbschema_tDBOutput_5.trim().length() == 0) {
					tableName_tDBOutput_5 = ("ODS_VENTE");
				} else {
					tableName_tDBOutput_5 = dbschema_tDBOutput_5 + "\".\"" + ("ODS_VENTE");
				}

				int updateKeyCount_tDBOutput_5 = 1;
				if (updateKeyCount_tDBOutput_5 < 1) {
					throw new RuntimeException("For update, Schema must have a key");
				} else if (updateKeyCount_tDBOutput_5 == 11 && true) {
				...
				String url_tDBOutput_5 = "jdbc:postgresql://" + context.serverName + ":" + context.port + "/"
						+ context.database + "?" + context.additionalParam;
				...
				dbschema_tDBOutput_2 = context.schema_ods;
				...
				String url_tDBOutput_2 = "jdbc:postgresql://" + context.serverName + ":" + context.port + "/"
						+ context.database + "?" + context.additionalParam;
				...
				String insert_tDBOutput_2 = "INSERT INTO \"" + tableName_tDBOutput_2
						+ "\" (\"ID_VENTE\",\"CD_PRODUIT\",\"DT_VENTE\",\"ID_CLIENT\",\"QTE_VENTE\",\"PRIX_ACHAT\",\"PRIX_VENTE\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"LB_JOB_NAME\",\"BL_LIGNE_IN_DWH\") VALUES (?,?,?,?,?,?,?,?,?,?,?)";
...
// # Outputs initialization
				...
				updateVenteStruct updateVente_tmp = new updateVenteStruct();
// ###############################
				...
				java.sql.PreparedStatement pstmt_tDBOutput_7 = conn_tDBOutput_7
						.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_7
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "produitVente");
				}
...
// ###############################
				...
				java.sql.PreparedStatement pstmt_tDBOutput_6 = conn_tDBOutput_6
						.prepareStatement("SELECT COUNT(1) FROM \"" + tableName_tDBOutput_6
								+ "\" WHERE \"LB_CHEMIN_FICHIER\" = ? AND \"LB_NOM_FICHIER\" = ? AND \"NUM_LIGNE_REJET\" = ? AND \"LB_LIGNE_REJET\" = ?");
...
// ###############################
// # Outputs initialization
				produitVenteStruct produitVente_tmp = new produitVenteStruct();
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format(
											...
											"DT_VENTE", "row1", temp, ex_tFileInputDelimited_1),
...
// # Output table : 'vente'
								...
								vente_tmp.CD_PRODUIT = row1.CD_PRODUIT;
								vente_tmp.DT_VENTE = row1.DT_VENTE;
								vente_tmp.ID_CLIENT = row1.ID_CLIENT;
								vente_tmp.QTE_VENTE = row1.QTE_VENTE;
								vente_tmp.PRIX_ACHAT = row1.PRIX_ACHAT;
								vente_tmp.PRIX_VENTE = row1.PRIX_VENTE;
								vente_tmp.NUM_LIGNE = Numeric.sequence("s1", 1, 1);
								vente = vente_tmp;
// ###############################
...
// Start of branch "vente"
							if (vente != null) {
								...
								ope_tFilterRow_1.matches((// code sample : use vente to define the condition.
// vente.columnName1.equals("foo") ||!(vente.columnName2.equals("bar"))
// replace the following expression by your own filter condition 
								!vente.ID_VENTE.isEmpty()), "advanced condition failed");

								if (ope_tFilterRow_1.getMatchFlag()) {
									if (row2 == null) {
										row2 = new row2Struct();
									}
									row2.ID_VENTE = vente.ID_VENTE;
									row2.CD_PRODUIT = vente.CD_PRODUIT;
									row2.DT_VENTE = vente.DT_VENTE;
									row2.ID_CLIENT = vente.ID_CLIENT;
									row2.QTE_VENTE = vente.QTE_VENTE;
									row2.PRIX_ACHAT = vente.PRIX_ACHAT;
									row2.PRIX_VENTE = vente.PRIX_VENTE;
									row2.NUM_LIGNE = vente.NUM_LIGNE;
									nb_line_ok_tFilterRow_1++;
								} else {
									if (row5 == null) {
										row5 = new row5Struct();
									}
									row5.ID_VENTE = vente.ID_VENTE;
									row5.CD_PRODUIT = vente.CD_PRODUIT;
									row5.DT_VENTE = vente.DT_VENTE;
									row5.ID_CLIENT = vente.ID_CLIENT;
									row5.QTE_VENTE = vente.QTE_VENTE;
									row5.PRIX_ACHAT = vente.PRIX_ACHAT;
									row5.PRIX_VENTE = vente.PRIX_VENTE;
									row5.NUM_LIGNE = vente.NUM_LIGNE;
...
// Start of branch "row2"
								if (row2 != null) {
									...
									if (!keystUniqRow_1.contains(finder_tUniqRow_1)) {
										...
										row6.ID_VENTE = row2.ID_VENTE;
										row6.CD_PRODUIT = row2.CD_PRODUIT;
										row6.DT_VENTE = row2.DT_VENTE;
										row6.ID_CLIENT = row2.ID_CLIENT;
										row6.QTE_VENTE = row2.QTE_VENTE;
										row6.PRIX_ACHAT = row2.PRIX_ACHAT;
										row6.PRIX_VENTE = row2.PRIX_VENTE;
...
// Start of branch "row3"
									if (row3 != null) {
										...
										if (!rejectedInnerJoin_tMap_5) { // G_TM_M_020
											...
											row7HashKey.CD_PRODUIT = row3.CD_PRODUIT;
										...
										if (tHash_Lookup_row7 != null && tHash_Lookup_row7.getCount(row7HashKey) > 1) { // G
											...
											// 'row7' and it contains more one result from keys : row7.CD_PRODUIT = '" +
											// row7HashKey.CD_PRODUIT + "'");
										} // G 071
...
// # Output table : 'produitVente'
												produitVente_tmp.ID_VENTE = row3.ID_VENTE;
												produitVente_tmp.CD_PRODUIT = row3.CD_PRODUIT;
												produitVente_tmp.DT_VENTE = row3.DT_VENTE;
												produitVente_tmp.ID_CLIENT = row3.ID_CLIENT;
												produitVente_tmp.QTE_VENTE = row3.QTE_VENTE;
												produitVente_tmp.PRIX_ACHAT = row3.PRIX_ACHAT;
												produitVente_tmp.PRIX_VENTE = row3.PRIX_VENTE;
												produitVente_tmp.NUM_LIGNE = row3.NUM_LIGNE;
												produitVente = produitVente_tmp;
...
// # Filter conditions 
											if (rejectedInnerJoin_tMap_5) {
												produitManquant_tmp.LB_CHEMIN_FICHIER = ((String) globalMap
														.get("tFileList_1_CURRENT_FILEPATH"));
												produitManquant_tmp.LB_NOM_FICHIER = ((String) globalMap
														.get("tFileList_1_CURRENT_FILE"));
												produitManquant_tmp.NUM_LIGNE_REJET = row3.NUM_LIGNE;
												produitManquant_tmp.LB_LIGNE_REJET = row3.ID_VENTE;
												produitManquant_tmp.LB_MESSAGE_REJET = "Produit Manquant!  "
														+ row3.CD_PRODUIT;
...
// Start of branch "produitVente"
										if (produitVente != null) {
											...
											if (!rejectedInnerJoin_tMap_6) { // G_TM_M_020
												...
												row8HashKey.ID_CLIENT = produitVente.ID_CLIENT;
											...
											if (tHash_Lookup_row8 != null
												...
												// row8.ID_CLIENT = '" + row8HashKey.ID_CLIENT + "'");
											} // G 071
...
// # Output table : 'ventes'
													ventes_tmp.ID_VENTE = produitVente.ID_VENTE;
													ventes_tmp.CD_PRODUIT = produitVente.CD_PRODUIT;
													ventes_tmp.DT_VENTE = produitVente.DT_VENTE;
													ventes_tmp.ID_CLIENT = produitVente.ID_CLIENT;
													ventes_tmp.QTE_VENTE = produitVente.QTE_VENTE;
													ventes_tmp.PRIX_ACHAT = produitVente.PRIX_ACHAT;
													ventes_tmp.PRIX_VENTE = produitVente.PRIX_VENTE;
													ventes_tmp.NUM_LIGNE = produitVente.NUM_LIGNE;
													ventes = ventes_tmp;
												} // closing inner join bracket (1)
// ###### START REJECTS ##### 
...
// # Filter conditions 
												if (rejectedInnerJoin_tMap_6) {
													clientManquant_tmp.LB_CHEMIN_FICHIER = ((String) globalMap
															.get("tFileList_1_CURRENT_FILEPATH"));
													clientManquant_tmp.LB_NOM_FICHIER = ((String) globalMap
															.get("tFileList_1_CURRENT_FILE"));
													clientManquant_tmp.NUM_LIGNE_REJET = produitVente.NUM_LIGNE;
													clientManquant_tmp.LB_LIGNE_REJET = produitVente.ID_VENTE;
													clientManquant_tmp.LB_MESSAGE_REJET = "Client manquant ! "
															+ produitVente.ID_CLIENT;
													clientManquant_tmp.LB_NOM_FLUX = ((String) globalMap
															.get("nom_flux"));
...
// # Output table : 'updateVente'
// # Filter conditions 
														if (

														!ventes.DT_VENTE.equals(row4.DT_VENTE)
																|| !ventes.ID_CLIENT.equals(row4.ID_CLIENT)
																|| !ventes.QTE_VENTE.equals(row4.QTE_VENTE)
																|| !ventes.PRIX_ACHAT.equals(row4.PRIX_ACHAT)
																|| !ventes.PRIX_VENTE.equals(row4.PRIX_VENTE)

														) {
															updateVente_tmp.ID_VENTE = ventes.ID_VENTE;
															updateVente_tmp.CD_PRODUIT = ventes.CD_PRODUIT;
															updateVente_tmp.DT_VENTE = ventes.DT_VENTE;
															updateVente_tmp.ID_CLIENT = ventes.ID_CLIENT;
															updateVente_tmp.QTE_VENTE = ventes.QTE_VENTE;
															updateVente_tmp.PRIX_ACHAT = ventes.PRIX_ACHAT;
															updateVente_tmp.PRIX_VENTE = ventes.PRIX_VENTE;
															updateVente_tmp.LB_NOM_FICHIER = ((String) globalMap
																	.get("tFileList_1_CURRENT_FILE"));
															updateVente_tmp.DT_INSERTION = TalendDate.getCurrentDate();
															updateVente_tmp.LB_JOB_NAME = jobName;
															updateVente_tmp.BL_LIGNE_IN_DWH = false;
															updateVente = updateVente_tmp;
														} // closing filter/reject
// ###### START REJECTS ##### 
// ###############################
...
// Start of branch "updateVente"
													if (updateVente != null) {
														...
														if (updateVente.CD_PRODUIT == null) {
															pstmt_tDBOutput_5.setNull(1, java.sql.Types.VARCHAR);
														} else {
															pstmt_tDBOutput_5.setString(1, updateVente.CD_PRODUIT);
														}

														if (updateVente.DT_VENTE != null) {
															pstmt_tDBOutput_5.setTimestamp(2, new java.sql.Timestamp(
																	updateVente.DT_VENTE.getTime()));
														} else {
															pstmt_tDBOutput_5.setNull(2, java.sql.Types.TIMESTAMP);
														}

														if (updateVente.ID_CLIENT == null) {
															pstmt_tDBOutput_5.setNull(3, java.sql.Types.VARCHAR);
														} else {
															pstmt_tDBOutput_5.setString(3, updateVente.ID_CLIENT);
														}

														pstmt_tDBOutput_5.setInt(4, updateVente.QTE_VENTE);

														pstmt_tDBOutput_5.setBigDecimal(5, updateVente.PRIX_ACHAT);

														pstmt_tDBOutput_5.setBigDecimal(6, updateVente.PRIX_VENTE);

														if (updateVente.LB_NOM_FICHIER == null) {
															pstmt_tDBOutput_5.setNull(7, java.sql.Types.VARCHAR);
														} else {
															pstmt_tDBOutput_5.setString(7, updateVente.LB_NOM_FICHIER);
														}

														if (updateVente.DT_INSERTION != null) {
															pstmt_tDBOutput_5.setTimestamp(8, new java.sql.Timestamp(
																	updateVente.DT_INSERTION.getTime()));
														} else {
															pstmt_tDBOutput_5.setNull(8, java.sql.Types.TIMESTAMP);
														}

														if (updateVente.LB_JOB_NAME == null) {
															pstmt_tDBOutput_5.setNull(9, java.sql.Types.VARCHAR);
														} else {
															pstmt_tDBOutput_5.setString(9, updateVente.LB_JOB_NAME);
														}

														pstmt_tDBOutput_5.setBoolean(10, updateVente.BL_LIGNE_IN_DWH);

														if (updateVente.ID_VENTE == null) {
															pstmt_tDBOutput_5.setNull(11 + count_tDBOutput_5,
																	java.sql.Types.VARCHAR);
														} else {
															pstmt_tDBOutput_5.setString(11 + count_tDBOutput_5,
																	updateVente.ID_VENTE);
														}
														...
														if ((batchSize_tDBOutput_5 > 0)
															...
															try {
																...
																for (int countEach_tDBOutput_5 : pstmt_tDBOutput_5
																		.executeBatch()) {
																	countSum_tDBOutput_5 += (countEach_tDBOutput_5 < 0
																			? 0
																...
																globalMap.put("tDBOutput_5_ERROR_MESSAGE",
...
// Start of branch "insertVente"
													if (insertVente != null) {
														...
														if (insertVente.ID_VENTE == null) {
															...
															pstmt_tDBOutput_2.setString(1, insertVente.ID_VENTE);
														}

														if (insertVente.CD_PRODUIT == null) {
															pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
														} else {
															pstmt_tDBOutput_2.setString(2, insertVente.CD_PRODUIT);
														}

														if (insertVente.DT_VENTE != null) {
															pstmt_tDBOutput_2.setTimestamp(3, new java.sql.Timestamp(
																	insertVente.DT_VENTE.getTime()));
														} else {
														...
														if (insertVente.ID_CLIENT == null) {
															...
															pstmt_tDBOutput_2.setString(4, insertVente.ID_CLIENT);
														}
														...
														if (insertVente.LB_NOM_FICHIER == null) {
															...
															pstmt_tDBOutput_2.setString(8, insertVente.LB_NOM_FICHIER);
														}

														if (insertVente.DT_INSERTION != null) {
															pstmt_tDBOutput_2.setTimestamp(9, new java.sql.Timestamp(
														...
														if (insertVente.LB_JOB_NAME == null) {
															...
															pstmt_tDBOutput_2.setString(10, insertVente.LB_JOB_NAME);
														}

														pstmt_tDBOutput_2.setBoolean(11, insertVente.BL_LIGNE_IN_DWH);
														...
														if ((batchSize_tDBOutput_2 > 0)
															...
															try {
																...
																for (int countEach_tDBOutput_2 : pstmt_tDBOutput_2
																		.executeBatch()) {
																	countSum_tDBOutput_2 += (countEach_tDBOutput_2 < 0
																			? 0
...
// Start of branch "clientManquant"
											if (clientManquant != null) {
												...
												if (clientManquant.LB_CHEMIN_FICHIER == null) {
													...
													pstmt_tDBOutput_7.setString(1, clientManquant.LB_CHEMIN_FICHIER);
												}

												if (clientManquant.LB_NOM_FICHIER == null) {
													pstmt_tDBOutput_7.setNull(2, java.sql.Types.VARCHAR);
												} else {
													pstmt_tDBOutput_7.setString(2, clientManquant.LB_NOM_FICHIER);
												}
												...
												if (clientManquant.LB_LIGNE_REJET == null) {
													...
													pstmt_tDBOutput_7.setString(4, clientManquant.LB_LIGNE_REJET);
												}

												int checkCount_tDBOutput_7 = -1;
												try (java.sql.ResultSet rs_tDBOutput_7 = pstmt_tDBOutput_7
														.executeQuery()) {
												...
												if (checkCount_tDBOutput_7 > 0) {
													if (clientManquant.LB_MESSAGE_REJET == null) {
														...
														pstmtUpdate_tDBOutput_7.setString(1,
																clientManquant.LB_MESSAGE_REJET);
													}

													if (clientManquant.LB_NOM_FLUX == null) {
														pstmtUpdate_tDBOutput_7.setNull(2, java.sql.Types.VARCHAR);
													} else {
														pstmtUpdate_tDBOutput_7.setString(2,
																clientManquant.LB_NOM_FLUX);
													}

													if (clientManquant.DT_REJET != null) {
														pstmtUpdate_tDBOutput_7.setTimestamp(3, new java.sql.Timestamp(
																clientManquant.DT_REJET.getTime()));
													} else {
													...
													if (clientManquant.LB_JOB_NAME == null) {
														...
														pstmtUpdate_tDBOutput_7.setString(4,
																clientManquant.LB_JOB_NAME);
													}

													if (clientManquant.LB_CHEMIN_FICHIER == null) {
														pstmtUpdate_tDBOutput_7.setNull(5 + count_tDBOutput_7,
																java.sql.Types.VARCHAR);
													} else {
														pstmtUpdate_tDBOutput_7.setString(5 + count_tDBOutput_7,
																clientManquant.LB_CHEMIN_FICHIER);
													}

													if (clientManquant.LB_NOM_FICHIER == null) {
														pstmtUpdate_tDBOutput_7.setNull(6 + count_tDBOutput_7,
																java.sql.Types.VARCHAR);
													} else {
														pstmtUpdate_tDBOutput_7.setString(6 + count_tDBOutput_7,
																clientManquant.LB_NOM_FICHIER);
													}

													pstmtUpdate_tDBOutput_7.setInt(7 + count_tDBOutput_7,
															clientManquant.NUM_LIGNE_REJET);
													...
													if (clientManquant.LB_LIGNE_REJET == null) {
														...
														pstmtUpdate_tDBOutput_7.setString(8 + count_tDBOutput_7,
																clientManquant.LB_LIGNE_REJET);
													}

													try {

														int processedCount_tDBOutput_7 = pstmtUpdate_tDBOutput_7
																.executeUpdate();
													...
													if (clientManquant.LB_CHEMIN_FICHIER == null) {
														...
														pstmtInsert_tDBOutput_7.setString(1,
																clientManquant.LB_CHEMIN_FICHIER);
													}
													...
													if (clientManquant.LB_LIGNE_REJET == null) {
														...
														pstmtInsert_tDBOutput_7.setString(4,
																clientManquant.LB_LIGNE_REJET);
													}
													...
													if (clientManquant.LB_MESSAGE_REJET == null) {
														...
														pstmtInsert_tDBOutput_7.setString(5,
																clientManquant.LB_MESSAGE_REJET);
													}
													...
													if (clientManquant.LB_NOM_FLUX == null) {
														...
														pstmtInsert_tDBOutput_7.setString(6,
																clientManquant.LB_NOM_FLUX);
													}

													if (clientManquant.DT_REJET != null) {
														pstmtInsert_tDBOutput_7.setTimestamp(7, new java.sql.Timestamp(
																clientManquant.DT_REJET.getTime()));
													} else {
													...
													if (clientManquant.LB_JOB_NAME == null) {
														...
														pstmtInsert_tDBOutput_7.setString(8,
																clientManquant.LB_JOB_NAME);
													}

													try {

														int processedCount_tDBOutput_7 = pstmtInsert_tDBOutput_7
																.executeUpdate();
...
// Start of branch "produitManquant"
										if (produitManquant != null) {
											...
											if (produitManquant.LB_CHEMIN_FICHIER == null) {
												...
												pstmt_tDBOutput_6.setString(1, produitManquant.LB_CHEMIN_FICHIER);
											}

											if (produitManquant.LB_NOM_FICHIER == null) {
												pstmt_tDBOutput_6.setNull(2, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_6.setString(2, produitManquant.LB_NOM_FICHIER);
											}

											pstmt_tDBOutput_6.setInt(3, produitManquant.NUM_LIGNE_REJET);

											if (produitManquant.LB_LIGNE_REJET == null) {
												pstmt_tDBOutput_6.setNull(4, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_6.setString(4, produitManquant.LB_LIGNE_REJET);
											}
											...
											if (checkCount_tDBOutput_6 > 0) {
												if (produitManquant.LB_MESSAGE_REJET == null) {
													...
													pstmtUpdate_tDBOutput_6.setString(1,
															produitManquant.LB_MESSAGE_REJET);
												}

												if (produitManquant.LB_NOM_FLUX == null) {
													pstmtUpdate_tDBOutput_6.setNull(2, java.sql.Types.VARCHAR);
												} else {
													pstmtUpdate_tDBOutput_6.setString(2, produitManquant.LB_NOM_FLUX);
												}

												if (produitManquant.DT_REJET != null) {
													pstmtUpdate_tDBOutput_6.setTimestamp(3,
															new java.sql.Timestamp(produitManquant.DT_REJET.getTime()));
												} else {
												...
												if (produitManquant.LB_JOB_NAME == null) {
													...
													pstmtUpdate_tDBOutput_6.setString(4, produitManquant.LB_JOB_NAME);
												}

												if (produitManquant.LB_CHEMIN_FICHIER == null) {
													pstmtUpdate_tDBOutput_6.setNull(5 + count_tDBOutput_6,
															java.sql.Types.VARCHAR);
												} else {
													pstmtUpdate_tDBOutput_6.setString(5 + count_tDBOutput_6,
															produitManquant.LB_CHEMIN_FICHIER);
												}

												if (produitManquant.LB_NOM_FICHIER == null) {
													pstmtUpdate_tDBOutput_6.setNull(6 + count_tDBOutput_6,
															java.sql.Types.VARCHAR);
												} else {
													pstmtUpdate_tDBOutput_6.setString(6 + count_tDBOutput_6,
															produitManquant.LB_NOM_FICHIER);
												}

												pstmtUpdate_tDBOutput_6.setInt(7 + count_tDBOutput_6,
														produitManquant.NUM_LIGNE_REJET);

												if (produitManquant.LB_LIGNE_REJET == null) {
													pstmtUpdate_tDBOutput_6.setNull(8 + count_tDBOutput_6,
															java.sql.Types.VARCHAR);
												} else {
													pstmtUpdate_tDBOutput_6.setString(8 + count_tDBOutput_6,
															produitManquant.LB_LIGNE_REJET);
												}

												try {

													int processedCount_tDBOutput_6 = pstmtUpdate_tDBOutput_6
															.executeUpdate();
												...
												pstmtInsert_tDBOutput_6.setInt(3, produitManquant.NUM_LIGNE_REJET);
												...
												if (produitManquant.LB_NOM_FLUX == null) {
													...
													pstmtInsert_tDBOutput_6.setString(6, produitManquant.LB_NOM_FLUX);
												}

												if (produitManquant.DT_REJET != null) {
													pstmtInsert_tDBOutput_6.setTimestamp(7,
															new java.sql.Timestamp(produitManquant.DT_REJET.getTime()));
												} else {
												...
												if (produitManquant.LB_JOB_NAME == null) {
													...
													pstmtInsert_tDBOutput_6.setString(8, produitManquant.LB_JOB_NAME);
												}

												try {

													int processedCount_tDBOutput_6 = pstmtInsert_tDBOutput_6
															.executeUpdate();
...
// # Output table : 'insertDuplicate'
											...
											insertDuplicate_tmp.LB_LIGNE_REJET = row6.ID_VENTE;
...
// Start of branch "insertDuplicate"
										if (insertDuplicate != null) {
											...
											if (insertDuplicate.LB_CHEMIN_FICHIER == null) {
												...
												pstmt_tDBOutput_4.setString(1, insertDuplicate.LB_CHEMIN_FICHIER);
											}

											if (insertDuplicate.LB_NOM_FICHIER == null) {
												pstmt_tDBOutput_4.setNull(2, java.sql.Types.VARCHAR);
											} else {
												pstmt_tDBOutput_4.setString(2, insertDuplicate.LB_NOM_FICHIER);
											}
											...
											if (insertDuplicate.LB_LIGNE_REJET == null) {
												...
												pstmt_tDBOutput_4.setString(4, insertDuplicate.LB_LIGNE_REJET);
											}
											...
											if (checkCount_tDBOutput_4 > 0) {
												...
												if (insertDuplicate.LB_NOM_FLUX == null) {
													...
													pstmtUpdate_tDBOutput_4.setString(2, insertDuplicate.LB_NOM_FLUX);
												}
												...
												if (insertDuplicate.LB_JOB_NAME == null) {
													...
													pstmtUpdate_tDBOutput_4.setString(4, insertDuplicate.LB_JOB_NAME);
												}
												...
												try {
													...
													int processedCount_tDBOutput_4 = pstmtUpdate_tDBOutput_4
															.executeUpdate();
												...
												if (insertDuplicate.LB_NOM_FICHIER == null) {
													...
													pstmtInsert_tDBOutput_4.setString(2,
															insertDuplicate.LB_NOM_FICHIER);
												}
												...
												if (insertDuplicate.LB_LIGNE_REJET == null) {
													...
													pstmtInsert_tDBOutput_4.setString(4,
															insertDuplicate.LB_LIGNE_REJET);
												}
												...
												if (insertDuplicate.LB_MESSAGE_REJET == null) {
													...
													pstmtInsert_tDBOutput_4.setString(5,
															insertDuplicate.LB_MESSAGE_REJET);
												}
												...
												if (insertDuplicate.LB_NOM_FLUX == null) {
													...
													pstmtInsert_tDBOutput_4.setString(6, insertDuplicate.LB_NOM_FLUX);
												}
												...
												if (insertDuplicate.LB_JOB_NAME == null) {
													...
													pstmtInsert_tDBOutput_4.setString(8, insertDuplicate.LB_JOB_NAME);
												}

												try {

													int processedCount_tDBOutput_4 = pstmtInsert_tDBOutput_4
															.executeUpdate();
...
// # Output table : 'insertReject'
										...
										insertReject_tmp.LB_LIGNE_REJET = row5.ID_VENTE;
...
// Start of branch "insertReject"
									if (insertReject != null) {
										...
										if (insertReject.LB_CHEMIN_FICHIER == null) {
											...
											pstmt_tDBOutput_1.setString(1, insertReject.LB_CHEMIN_FICHIER);
										}

										if (insertReject.LB_NOM_FICHIER == null) {
											pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
										} else {
											pstmt_tDBOutput_1.setString(2, insertReject.LB_NOM_FICHIER);
										}
										...
										if (insertReject.LB_LIGNE_REJET == null) {
											...
											pstmt_tDBOutput_1.setString(4, insertReject.LB_LIGNE_REJET);
										}
										...
										if (checkCount_tDBOutput_1 > 0) {
											if (insertReject.LB_MESSAGE_REJET == null) {
												...
												pstmtUpdate_tDBOutput_1.setString(1, insertReject.LB_MESSAGE_REJET);
											}

											if (insertReject.LB_NOM_FLUX == null) {
												pstmtUpdate_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
											} else {
												pstmtUpdate_tDBOutput_1.setString(2, insertReject.LB_NOM_FLUX);
											}
											...
											if (insertReject.LB_JOB_NAME == null) {
												...
												pstmtUpdate_tDBOutput_1.setString(4, insertReject.LB_JOB_NAME);
											}
											...
											if (insertReject.LB_CHEMIN_FICHIER == null) {
												...
												pstmtUpdate_tDBOutput_1.setString(5 + count_tDBOutput_1,
											...
											if (insertReject.LB_CHEMIN_FICHIER == null) {
												...
												pstmtInsert_tDBOutput_1.setString(1, insertReject.LB_CHEMIN_FICHIER);
											}

											if (insertReject.LB_NOM_FICHIER == null) {
												pstmtInsert_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
											} else {
												pstmtInsert_tDBOutput_1.setString(2, insertReject.LB_NOM_FICHIER);
											}
											...
											if (insertReject.LB_LIGNE_REJET == null) {
												...
												pstmtInsert_tDBOutput_1.setString(4, insertReject.LB_LIGNE_REJET);
											}

											if (insertReject.LB_MESSAGE_REJET == null) {
												pstmtInsert_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
											} else {
												pstmtInsert_tDBOutput_1.setString(5, insertReject.LB_MESSAGE_REJET);
											}

											if (insertReject.LB_NOM_FLUX == null) {
												pstmtInsert_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
											} else {
												pstmtInsert_tDBOutput_1.setString(6, insertReject.LB_NOM_FLUX);
											}
											...
											if (insertReject.LB_JOB_NAME == null) {
												...
												pstmtInsert_tDBOutput_1.setString(8, insertReject.LB_JOB_NAME);
											}
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "produitVente");
				}
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "updateVente");
				}
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:()
				// linked node: tMap_4 - inputs:(ventes,row4) outputs:(updateVente,insertVente)
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							row4.ID_VENTE = routines.system.JDBCUtil.getString(rs_tDBInput_1, 1, false);
						}
						if (colQtyInRs_tDBInput_1 < 2) {
							row4.CD_PRODUIT = null;
						} else {

							row4.CD_PRODUIT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 2, false);
						}
						if (colQtyInRs_tDBInput_1 < 3) {
							row4.DT_VENTE = null;
						} else {

							row4.DT_VENTE = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 3);
						}
						if (colQtyInRs_tDBInput_1 < 4) {
							row4.ID_CLIENT = null;
						} else {

							row4.ID_CLIENT = routines.system.JDBCUtil.getString(rs_tDBInput_1, 4, false);
						}
						if (colQtyInRs_tDBInput_1 < 5) {
							row4.QTE_VENTE = 0;
						} else {

							row4.QTE_VENTE = rs_tDBInput_1.getInt(5);
						...
						if (colQtyInRs_tDBInput_1 < 6) {
							...
							row4.PRIX_ACHAT = rs_tDBInput_1.getBigDecimal(6);
							if (rs_tDBInput_1.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_1 < 7) {
							...
							row4.PRIX_VENTE = rs_tDBInput_1.getBigDecimal(7);
							if (rs_tDBInput_1.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						if (colQtyInRs_tDBInput_1 < 8) {
							...
							row4.LB_NOM_FICHIER = routines.system.JDBCUtil.getString(rs_tDBInput_1, 8, false);
						}
						if (colQtyInRs_tDBInput_1 < 9) {
							row4.DT_INSERTION = null;
						} else {

							row4.DT_INSERTION = routines.system.JDBCUtil.getDate(rs_tDBInput_1, 9);
						}
						if (colQtyInRs_tDBInput_1 < 10) {
							row4.LB_JOB_NAME = null;
						} else {

							row4.LB_JOB_NAME = routines.system.JDBCUtil.getString(rs_tDBInput_1, 10, false);
						}
						if (colQtyInRs_tDBInput_1 < 11) {
							row4.BL_LIGNE_IN_DWH = false;
						} else {

							row4.BL_LIGNE_IN_DWH = rs_tDBInput_1.getBoolean(11);
							if (rs_tDBInput_1.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						...
						row4_HashRow.BL_LIGNE_IN_DWH = row4.BL_LIGNE_IN_DWH;
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:()
				// linked node: tMap_5 - inputs:(row3,row7)
				// outputs:(produitVente,produitManquant)
				...
				String url_tDBInput_2 = "jdbc:postgresql://" + context.serverName + ":" + context.port + "/"
						+ context.database + "?" + context.additionalParam;
				...
				String dbquery_tDBInput_2 = "SELECT \n  \"" + context.schema_ods
						...
						+ "\".\"ODS_PRODUIT\".\"PRIX_VENTE_PRODUIT\", \n  \"" + context.schema_ods
						+ "\".\"ODS_PRODUIT\".\"CD_SOUS_CATEGORIE\", \n  \"" + context.schema_ods
						+ "\".\"ODS_PRODUIT\".\"LB_NOM_FICHIER\", \n  \"" + context.schema_ods
						+ "\".\"ODS_PRODUIT\".\"DT_INSERTION\", \n  \"" + context.schema_ods
						+ "\".\"ODS_PRODUIT\".\"BL_LIGNE_ACTIVE\", \n  \"" + context.schema_ods
						+ "\".\"ODS_PRODUIT\".\"LB_JOB_NAME\"\nFROM \"" + context.schema_ods
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:()
				// linked node: tMap_6 - inputs:(produitVente,row8)
				// outputs:(ventes,clientManquant)
				...
				String url_tDBInput_3 = "jdbc:postgresql://" + context.serverName + ":" + context.port + "/"
						+ context.database + "?" + context.additionalParam;
				...
				String dbquery_tDBInput_3 = "SELECT \n  \"" + context.schema_ods
						...
						+ "\".\"ODS_CLIENT\".\"VILLE_CLIENT\", \n  \"" + context.schema_ods
						+ "\".\"ODS_CLIENT\".\"PAYS_CLIENT\", \n  \"" + context.schema_ods
						+ "\".\"ODS_CLIENT\".\"REGION_CLIENT\", \n  \"" + context.schema_ods
						+ "\".\"ODS_CLIENT\".\"CD_TYPE_CLIENT\", \n  \"" + context.schema_ods
						+ "\".\"ODS_CLIENT\".\"LB_NOM_FICHIER\", \n  \"" + context.schema_ods
						+ "\".\"ODS_CLIENT\".\"DT_INSERTION\", \n  \"" + context.schema_ods
						+ "\".\"ODS_CLIENT\".\"BL_LIGNE_ACTIVE\", \n  \"" + context.schema_ods
						+ "\".\"ODS_CLIENT\".\"LB_JOB_NAME\"\nFROM \"" + context.schema_ods
						+ "\".\"ODS_CLIENT\"\nWHERE \"BL_LIGNE_ACTIVE\"= 1;\n";
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = jODSVente.class.getClassLoader()
					.getResourceAsStream("k_commerce_reporting/jodsvente_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 476575 characters generated by Talend Open Studio for Data Integration on the
 * 18 novembre 2023 à 7:45:44 AM CET
 ************************************************************************************************/