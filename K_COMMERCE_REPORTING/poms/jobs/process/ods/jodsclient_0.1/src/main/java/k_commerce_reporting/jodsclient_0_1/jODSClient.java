...
package k_commerce_reporting.jodsclient_0_1;
...
/**
 * Job: jODSClient Purpose: jODSClient<br>
 * Description: jODSClient <br>
...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_K_COMMERCE_REPORTING_jODSClient = new byte[0];
    static byte[] commonByteArray_K_COMMERCE_REPORTING_jODSClient = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_K_COMMERCE_REPORTING_jODSClient.length) {
				if(length < 1024 && commonByteArray_K_COMMERCE_REPORTING_jODSClient.length == 0) {
   					commonByteArray_K_COMMERCE_REPORTING_jODSClient = new byte[1024];
				} else {
   					commonByteArray_K_COMMERCE_REPORTING_jODSClient = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_K_COMMERCE_REPORTING_jODSClient, 0, length);
			strReturn = new String(commonByteArray_K_COMMERCE_REPORTING_jODSClient, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_K_COMMERCE_REPORTING_jODSClient, 0, length);
			strReturn = new String(commonByteArray_K_COMMERCE_REPORTING_jODSClient, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_K_COMMERCE_REPORTING_jODSClient) {
...
public static class insertNewClientStruct implements routines.system.IPersistableRow<insertNewClientStruct> {
    final static byte[] commonByteArrayLock_K_COMMERCE_REPORTING_jODSClient = new byte[0];
    static byte[] commonByteArray_K_COMMERCE_REPORTING_jODSClient = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final insertNewClientStruct other = (insertNewClientStruct) obj;
	...
	public void copyDataTo(insertNewClientStruct other) {
	...
	public void copyKeysDataTo(insertNewClientStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(insertNewClientStruct other) {
...
public static class updateClientStruct implements routines.system.IPersistableRow<updateClientStruct> {
    final static byte[] commonByteArrayLock_K_COMMERCE_REPORTING_jODSClient = new byte[0];
    static byte[] commonByteArray_K_COMMERCE_REPORTING_jODSClient = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final updateClientStruct other = (updateClientStruct) obj;
	...
	public void copyDataTo(updateClientStruct other) {
	...
	public void copyKeysDataTo(updateClientStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(updateClientStruct other) {
...
insertNewClientStruct insertNewClient = new insertNewClientStruct();
updateClientStruct updateClient = new updateClientStruct();
 ...
 */
	...
	currentComponent="tDBOutput_2";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"insertNewClient");
					}
 ...
 */
	...
	currentComponent="tDBOutput_5";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"updateClient");
					}
...
if(dbschema_tDBOutput_5 == null || dbschema_tDBOutput_5.trim().length() == 0) {
	tableName_tDBOutput_5 = ("ODS_CLIENT");
} else {
	tableName_tDBOutput_5 = dbschema_tDBOutput_5 + "\".\"" + ("ODS_CLIENT");
}

        int updateKeyCount_tDBOutput_5 = 1;
        if(updateKeyCount_tDBOutput_5 < 1) {
            throw new RuntimeException("For update, Schema must have a key");
        } else if (updateKeyCount_tDBOutput_5 == 12 && true) {        
...
int count_tDBOutput_5=0;
	    String update_tDBOutput_5 = "UPDATE \"" + tableName_tDBOutput_5 + "\" SET \"NOM_CLIENT\" = ?,\"PREN_CLIENT\" = ?,\"CD_POSTAL_CLIENT\" = ?,\"VILLE_CLIENT\" = ?,\"PAYS_CLIENT\" = ?,\"REGION_CLIENT\" = ?,\"CD_TYPE_CLIENT\" = ?,\"LB_NOM_FICHIER\" = ?,\"DT_INSERTION\" = ?,\"BL_LIGNE_ACTIVE\" = ?,\"LB_JOB_NAME\" = ? WHERE \"ID_CLIENT\" = ?";
...
insertNewClientStruct insertNewClient_tmp = new insertNewClientStruct();
updateClientStruct updateClient_tmp = new updateClientStruct();
// ###############################
...
// # Output table : 'client'
client_tmp.ID_CLIENT = row1.ID_CLIENT ;
client_tmp.NOM_CLIENT = row1.NOM_CLIENT ;
client_tmp.PREN_CLIENT = row1.PREN_CLIENT ;
client_tmp.CD_POSTAL_CLIENT = row1.CD_POSTAL_CLIENT ;
client_tmp.VILLE_CLIENT = row1.VILLE_CLIENT ;
client_tmp.PAYS_CLIENT = row1.PAYS_CLIENT ;
client_tmp.REGION_CLIENT = row1.REGION_CLIENT ;
client_tmp.CD_TYPE_CLIENT = row1.CD_TYPE_CLIENT ;
client_tmp.NUM_LIGNE = Numeric.sequence("s1",1,1) ;
client = client_tmp;
// ###############################
...
if(client != null) { 
    ...
    Operator_tFilterRow_1 ope_tFilterRow_1 = new Operator_tFilterRow_1("&&");
      ope_tFilterRow_1.matches((// code sample : use client to define the condition.
// client.columnName1.equals("foo") ||!(client.columnName2.equals("bar"))
// replace the following expression by your own filter condition 
!client.ID_CLIENT.isEmpty()
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(row2 == null){ 
               ...
               row2.ID_CLIENT = client.ID_CLIENT;
               row2.NOM_CLIENT = client.NOM_CLIENT;
               row2.PREN_CLIENT = client.PREN_CLIENT;
               row2.CD_POSTAL_CLIENT = client.CD_POSTAL_CLIENT;
               row2.VILLE_CLIENT = client.VILLE_CLIENT;
               row2.PAYS_CLIENT = client.PAYS_CLIENT;
               row2.REGION_CLIENT = client.REGION_CLIENT;
               row2.CD_TYPE_CLIENT = client.CD_TYPE_CLIENT;
               row2.NUM_LIGNE = client.NUM_LIGNE;    
      nb_line_ok_tFilterRow_1++;
    } else {
            if (row5 == null){
              row5 = new row5Struct();
            }
                row5.ID_CLIENT = client.ID_CLIENT;
                row5.NOM_CLIENT = client.NOM_CLIENT;
                row5.PREN_CLIENT = client.PREN_CLIENT;
                row5.CD_POSTAL_CLIENT = client.CD_POSTAL_CLIENT;
                row5.VILLE_CLIENT = client.VILLE_CLIENT;
                row5.PAYS_CLIENT = client.PAYS_CLIENT;
                row5.REGION_CLIENT = client.REGION_CLIENT;
                row5.CD_TYPE_CLIENT = client.CD_TYPE_CLIENT;
                row5.NUM_LIGNE = client.NUM_LIGNE;
 					    ...
 					    boolean forceLooprow7 = false;
 							...
 							row7Struct row7ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_5 = false;
                        		    		    ...
                        		    		    row7HashKey.CD_TYPE_CLIENT = row3.CD_TYPE_CLIENT ;
								  ...
								  if(!tHash_Lookup_row7.hasNext()) { // G_TM_M_090
				           		...
				           		if(tHash_Lookup_row7 != null && tHash_Lookup_row7.getCount(row7HashKey) > 1) { // G 071
									...
									//System.out.println("WARNING: UNIQUE MATCH is configured for the lookup 'row7' and it contains more one result from keys :  row7.CD_TYPE_CLIENT = '" + row7HashKey.CD_TYPE_CLIENT + "'");
								} // G 071
...
clients_tmp.ID_CLIENT = row3.ID_CLIENT ;
clients_tmp.NOM_CLIENT = row3.NOM_CLIENT ;
clients_tmp.PREN_CLIENT = row3.PREN_CLIENT ;
clients_tmp.CD_POSTAL_CLIENT = row3.CD_POSTAL_CLIENT ;
clients_tmp.VILLE_CLIENT = row3.VILLE_CLIENT ;
clients_tmp.PAYS_CLIENT = row3.PAYS_CLIENT ;
clients_tmp.REGION_CLIENT = row3.REGION_CLIENT ;
clients_tmp.CD_TYPE_CLIENT = row3.CD_TYPE_CLIENT ;
clients_tmp.NUM_LIGNE = row3.NUM_LIGNE ;
clients = clients_tmp;
...
typeClientManquant_tmp.LB_LIGNE_REJET = row3.ID_CLIENT ;
typeClientManquant_tmp.LB_MESSAGE_REJET = "Type Client Manquant " +  row3.CD_TYPE_CLIENT ;
 					    ...
 					    boolean forceLooprow4 = false;
 							...
 							row4Struct row4ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_2 = false;
                        		    		    ...
                        		    		    row4HashKey.ID_CLIENT = clients.ID_CLIENT ;
...
insertNewClient = null;
updateClient = null;
insertClient = null;

if(!rejectedInnerJoin_tMap_2 ) {

// # Output table : 'insertNewClient'
// # Filter conditions 
if( 

!clients.NOM_CLIENT.equals(row4.NOM_CLIENT)
|| !clients.PREN_CLIENT.equals(row4.PREN_CLIENT) 
|| !clients.CD_POSTAL_CLIENT.equals(row4.CD_POSTAL_CLIENT)
||!clients.VILLE_CLIENT.equals(row4.VILLE_CLIENT)
||!clients.PAYS_CLIENT.equals(row4.PAYS_CLIENT)
||!clients.REGION_CLIENT.equals(row4.REGION_CLIENT)
||!  clients.CD_TYPE_CLIENT.equals(row4.CD_TYPE_CLIENT)

 ) {
insertNewClient_tmp.ID_CLIENT = clients.ID_CLIENT ;
insertNewClient_tmp.NOM_CLIENT = clients.NOM_CLIENT ;
insertNewClient_tmp.PREN_CLIENT = clients.PREN_CLIENT ;
insertNewClient_tmp.CD_POSTAL_CLIENT = clients.CD_POSTAL_CLIENT ;
insertNewClient_tmp.VILLE_CLIENT = clients.VILLE_CLIENT ;
insertNewClient_tmp.PAYS_CLIENT = clients.PAYS_CLIENT ;
insertNewClient_tmp.REGION_CLIENT = clients.REGION_CLIENT ;
insertNewClient_tmp.CD_TYPE_CLIENT = clients.CD_TYPE_CLIENT ;
insertNewClient_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
insertNewClient_tmp.DT_INSERTION = TalendDate.getCurrentDate();
insertNewClient_tmp.BL_LIGNE_ACTIVE = 1;
insertNewClient_tmp.LB_JOB_NAME = jobName;
insertNewClient = insertNewClient_tmp;
} // closing filter/reject

// # Output table : 'updateClient'
// # Filter conditions 
if( 
...
updateClient_tmp.ID_CLIENT = clients.ID_CLIENT ;
updateClient_tmp.NOM_CLIENT = null;
updateClient_tmp.PREN_CLIENT = null;
updateClient_tmp.CD_POSTAL_CLIENT = null;
updateClient_tmp.VILLE_CLIENT = null;
updateClient_tmp.PAYS_CLIENT = null;
updateClient_tmp.REGION_CLIENT = null;
updateClient_tmp.CD_TYPE_CLIENT = null;
updateClient_tmp.LB_NOM_FICHIER = null;
updateClient_tmp.DT_INSERTION = null;
updateClient_tmp.BL_LIGNE_ACTIVE = 0;
updateClient_tmp.LB_JOB_NAME = null;
updateClient = updateClient_tmp;
} // closing filter/reject
} // closing inner join bracket (1)
// ###### START REJECTS ##### 
...
} else {pstmt_tDBOutput_1.setString(9, insertClient.LB_NOM_FICHIER);
}
...
// Start of branch "insertNewClient"
if(insertNewClient != null) { 
	...
	currentComponent="tDBOutput_2";
        ...
        whetherReject_tDBOutput_2 = false;
                    if(insertNewClient.ID_CLIENT == null) {
pstmt_tDBOutput_2.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(1, insertNewClient.ID_CLIENT);
}

                    if(insertNewClient.NOM_CLIENT == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, insertNewClient.NOM_CLIENT);
}

                    if(insertNewClient.PREN_CLIENT == null) {
pstmt_tDBOutput_2.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(3, insertNewClient.PREN_CLIENT);
}

                    if(insertNewClient.CD_POSTAL_CLIENT == null) {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(4, insertNewClient.CD_POSTAL_CLIENT);
}

                    if(insertNewClient.VILLE_CLIENT == null) {
pstmt_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(5, insertNewClient.VILLE_CLIENT);
}

                    if(insertNewClient.PAYS_CLIENT == null) {
pstmt_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(6, insertNewClient.PAYS_CLIENT);
}

                    if(insertNewClient.REGION_CLIENT == null) {
pstmt_tDBOutput_2.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(7, insertNewClient.REGION_CLIENT);
}

                    if(insertNewClient.CD_TYPE_CLIENT == null) {
pstmt_tDBOutput_2.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(8, insertNewClient.CD_TYPE_CLIENT);
}

                    if(insertNewClient.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_2.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(9, insertNewClient.LB_NOM_FICHIER);
}

                    if(insertNewClient.DT_INSERTION != null) {
pstmt_tDBOutput_2.setTimestamp(10, new java.sql.Timestamp(insertNewClient.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_2.setNull(10, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_2.setInt(11, insertNewClient.BL_LIGNE_ACTIVE);

                    if(insertNewClient.LB_JOB_NAME == null) {
pstmt_tDBOutput_2.setNull(12, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(12, insertNewClient.LB_JOB_NAME);
}
...
} // End of branch "insertNewClient"




// Start of branch "updateClient"
if(updateClient != null) { 
	...
	currentComponent="tDBOutput_5";
        ...
        whetherReject_tDBOutput_5 = false;
                    if(updateClient.NOM_CLIENT == null) {
pstmt_tDBOutput_5.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(1, updateClient.NOM_CLIENT);
}

                    if(updateClient.PREN_CLIENT == null) {
pstmt_tDBOutput_5.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(2, updateClient.PREN_CLIENT);
}

                    if(updateClient.CD_POSTAL_CLIENT == null) {
pstmt_tDBOutput_5.setNull(3, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(3, updateClient.CD_POSTAL_CLIENT);
}

                    if(updateClient.VILLE_CLIENT == null) {
pstmt_tDBOutput_5.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(4, updateClient.VILLE_CLIENT);
}

                    if(updateClient.PAYS_CLIENT == null) {
pstmt_tDBOutput_5.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(5, updateClient.PAYS_CLIENT);
}

                    if(updateClient.REGION_CLIENT == null) {
pstmt_tDBOutput_5.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(6, updateClient.REGION_CLIENT);
}

                    if(updateClient.CD_TYPE_CLIENT == null) {
pstmt_tDBOutput_5.setNull(7, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(7, updateClient.CD_TYPE_CLIENT);
}

                    if(updateClient.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_5.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(8, updateClient.LB_NOM_FICHIER);
}

                    if(updateClient.DT_INSERTION != null) {
pstmt_tDBOutput_5.setTimestamp(9, new java.sql.Timestamp(updateClient.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_5.setNull(9, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_5.setInt(10, updateClient.BL_LIGNE_ACTIVE);

                    if(updateClient.LB_JOB_NAME == null) {
pstmt_tDBOutput_5.setNull(11, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(11, updateClient.LB_JOB_NAME);
}

                    if(updateClient.ID_CLIENT == null) {
pstmt_tDBOutput_5.setNull(12 + count_tDBOutput_5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(12 + count_tDBOutput_5, updateClient.ID_CLIENT);
}
...
} else {pstmt_tDBOutput_6.setString(1, typeClientManquant.LB_CHEMIN_FICHIER);
}

                    if(typeClientManquant.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_6.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(2, typeClientManquant.LB_NOM_FICHIER);
}

                    pstmt_tDBOutput_6.setInt(3, typeClientManquant.NUM_LIGNE_REJET);

                    if(typeClientManquant.LB_LIGNE_REJET == null) {
pstmt_tDBOutput_6.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(4, typeClientManquant.LB_LIGNE_REJET);
}
...
} else {pstmtUpdate_tDBOutput_6.setString(1, typeClientManquant.LB_MESSAGE_REJET);
}

                        if(typeClientManquant.LB_NOM_FLUX == null) {
pstmtUpdate_tDBOutput_6.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_6.setString(2, typeClientManquant.LB_NOM_FLUX);
}

                        if(typeClientManquant.DT_REJET != null) {
pstmtUpdate_tDBOutput_6.setTimestamp(3, new java.sql.Timestamp(typeClientManquant.DT_REJET.getTime()));
} else {
...
} else {pstmtUpdate_tDBOutput_6.setString(4, typeClientManquant.LB_JOB_NAME);
}

                        if(typeClientManquant.LB_CHEMIN_FICHIER == null) {
pstmtUpdate_tDBOutput_6.setNull(5 + count_tDBOutput_6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_6.setString(5 + count_tDBOutput_6, typeClientManquant.LB_CHEMIN_FICHIER);
}

                        if(typeClientManquant.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_6.setNull(6 + count_tDBOutput_6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_6.setString(6 + count_tDBOutput_6, typeClientManquant.LB_NOM_FICHIER);
}

                        pstmtUpdate_tDBOutput_6.setInt(7 + count_tDBOutput_6, typeClientManquant.NUM_LIGNE_REJET);

                        if(typeClientManquant.LB_LIGNE_REJET == null) {
pstmtUpdate_tDBOutput_6.setNull(8 + count_tDBOutput_6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_6.setString(8 + count_tDBOutput_6, typeClientManquant.LB_LIGNE_REJET);
}
...
} else {pstmtInsert_tDBOutput_6.setString(1, typeClientManquant.LB_CHEMIN_FICHIER);
}

                        if(typeClientManquant.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_6.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_6.setString(2, typeClientManquant.LB_NOM_FICHIER);
}

                        pstmtInsert_tDBOutput_6.setInt(3, typeClientManquant.NUM_LIGNE_REJET);

                        if(typeClientManquant.LB_LIGNE_REJET == null) {
pstmtInsert_tDBOutput_6.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_6.setString(4, typeClientManquant.LB_LIGNE_REJET);
}

                        if(typeClientManquant.LB_MESSAGE_REJET == null) {
pstmtInsert_tDBOutput_6.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_6.setString(5, typeClientManquant.LB_MESSAGE_REJET);
}

                        if(typeClientManquant.LB_NOM_FLUX == null) {
pstmtInsert_tDBOutput_6.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_6.setString(6, typeClientManquant.LB_NOM_FLUX);
}

                        if(typeClientManquant.DT_REJET != null) {
pstmtInsert_tDBOutput_6.setTimestamp(7, new java.sql.Timestamp(typeClientManquant.DT_REJET.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_6.setString(8, typeClientManquant.LB_JOB_NAME);
}
...
insertDuplicate_tmp.LB_LIGNE_REJET = row6.ID_CLIENT;
...
insertReject_tmp.LB_LIGNE_REJET = row5.ID_CLIENT;
...
globalMap.put("tDBOutput_2_ERROR_MESSAGE",e_tDBOutput_2.getMessage());
	...
	nb_line_rejected_tDBOutput_2=nb_line_rejected_tDBOutput_2 + rejectedCount_tDBOutput_2;
        ...
        globalMap.put("tDBOutput_2_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_2);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"insertNewClient");
			  	}
...
globalMap.put("tDBOutput_5_ERROR_MESSAGE",e_tDBOutput_5.getMessage());
	...
	nb_line_rejected_tDBOutput_5=nb_line_rejected_tDBOutput_5 + rejectedCount_tDBOutput_5;
        ...
        globalMap.put("tDBOutput_5_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_5);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"updateClient");
			  	}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row7";
		...
		int tos_count_tAdvancedHash_row7 = 0;
			   		...
			   		// linked node: tMap_5 - inputs:(row3,row7) outputs:(clients,typeClientManquant)
 ...
 */
	...
	final String decryptedPassword_tDBInput_2 = context.password; 
        	...
        	row7.CD_TYPE_CLIENT = routines.system.JDBCUtil.getString(rs_tDBInput_2, 1, false);
		                    }
							if(colQtyInRs_tDBInput_2 < 2) {
								row7.LB_TYPE_CLIENT = null;
							} else {
	                         		
        	row7.LB_TYPE_CLIENT = routines.system.JDBCUtil.getString(rs_tDBInput_2, 2, false);
		                    }
 ...
 */
	...
	currentComponent="tAdvancedHash_row7";
				...
				row7_HashRow.LB_TYPE_CLIENT = row7.LB_TYPE_CLIENT;
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// linked node: tMap_2 - inputs:(clients,row4) outputs:(insertClient,insertNewClient,updateClient)
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jODSClient.class.getClassLoader().getResourceAsStream("k_commerce_reporting/jodsclient_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     428136 characters generated by Talend Open Studio for Data Integration 
 *     on the 18 novembre 2023 à 12:13:28 AM CET
 ************************************************************************************************/