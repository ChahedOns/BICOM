...
package k_commerce_reporting.jodsproduit_0_1;
...
/**
 * Job: jODSProduit Purpose: jODSProduit<br>
 * Description: jODSProduit <br>
...
public static class row_Implicit_Context_DatabaseStruct implements routines.system.IPersistableRow<row_Implicit_Context_DatabaseStruct> {
    final static byte[] commonByteArrayLock_K_COMMERCE_REPORTING_jODSProduit = new byte[0];
    static byte[] commonByteArray_K_COMMERCE_REPORTING_jODSProduit = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_K_COMMERCE_REPORTING_jODSProduit.length) {
				if(length < 1024 && commonByteArray_K_COMMERCE_REPORTING_jODSProduit.length == 0) {
   					commonByteArray_K_COMMERCE_REPORTING_jODSProduit = new byte[1024];
				} else {
   					commonByteArray_K_COMMERCE_REPORTING_jODSProduit = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_K_COMMERCE_REPORTING_jODSProduit, 0, length);
			strReturn = new String(commonByteArray_K_COMMERCE_REPORTING_jODSProduit, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_K_COMMERCE_REPORTING_jODSProduit, 0, length);
			strReturn = new String(commonByteArray_K_COMMERCE_REPORTING_jODSProduit, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_K_COMMERCE_REPORTING_jODSProduit) {
...
public static class sousCategorieManquanteStruct implements routines.system.IPersistableRow<sousCategorieManquanteStruct> {
    final static byte[] commonByteArrayLock_K_COMMERCE_REPORTING_jODSProduit = new byte[0];
    static byte[] commonByteArray_K_COMMERCE_REPORTING_jODSProduit = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final sousCategorieManquanteStruct other = (sousCategorieManquanteStruct) obj;
	...
	public void copyDataTo(sousCategorieManquanteStruct other) {
	...
	public void copyKeysDataTo(sousCategorieManquanteStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(sousCategorieManquanteStruct other) {
...
sousCategorieManquanteStruct sousCategorieManquante = new sousCategorieManquanteStruct();
...
String dbschema_tDBOutput_3 = null;
	dbschema_tDBOutput_3 = context.schema_ods;
...
String dbschema_tDBOutput_4 = null;
	dbschema_tDBOutput_4 = context.schema_ods;
	

String tableName_tDBOutput_4 = null;
if(dbschema_tDBOutput_4 == null || dbschema_tDBOutput_4.trim().length() == 0) {
	tableName_tDBOutput_4 = ("ODS_PRODUIT");
} else {
	tableName_tDBOutput_4 = dbschema_tDBOutput_4 + "\".\"" + ("ODS_PRODUIT");
}
...
int count_tDBOutput_4=0;
	    String insert_tDBOutput_4 = "INSERT INTO \"" + tableName_tDBOutput_4 + "\" (\"CD_PRODUIT\",\"NOM_PRODUIT\",\"PRIX_ACHAT_PRODUIT\",\"PRIX_VENTE_PRODUIT\",\"CD_SOUS_CATEGORIE\",\"LB_NOM_FICHIER\",\"DT_INSERTION\",\"BL_LIGNE_ACTIVE\",\"LB_JOB_NAME\") VALUES (?,?,?,?,?,?,?,?,?)";
...
if(dbschema_tDBOutput_5 == null || dbschema_tDBOutput_5.trim().length() == 0) {
	tableName_tDBOutput_5 = ("ODS_PRODUIT");
} else {
	tableName_tDBOutput_5 = dbschema_tDBOutput_5 + "\".\"" + ("ODS_PRODUIT");
}
...
int count_tDBOutput_5=0;
	    String update_tDBOutput_5 = "UPDATE \"" + tableName_tDBOutput_5 + "\" SET \"NOM_PRODUIT\" = ?,\"PRIX_ACHAT_PRODUIT\" = ?,\"PRIX_VENTE_PRODUIT\" = ?,\"CD_SOUS_CATEGORIE\" = ?,\"LB_NOM_FICHIER\" = ?,\"DT_INSERTION\" = ?,\"BL_LIGNE_ACTIVE\" = ?,\"LB_JOB_NAME\" = ? WHERE \"CD_PRODUIT\" = ?";
 ...
 */
	...
	currentComponent="tDBOutput_6";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"sousCategorieManquante");
					}
...
sousCategorieManquanteStruct sousCategorieManquante_tmp = new sousCategorieManquanteStruct();
// ###############################
...
produit_tmp.CD_PRODUIT = row1.CD_PRODUIT ;
produit_tmp.NOM_PRODUIT = row1.NOM_PRODUIT ;
produit_tmp.PRIX_ACHAT_PRODUIT = row1.PRIX_ACHAT_PRODUIT ;
produit_tmp.PRIX_VENTE_PRODUIT = row1.PRIX_VENTE_PRODUIT ;
produit_tmp.CD_SOUS_CATEGORIE = row1.CD_SOUS_CATEGORIE ;
produit_tmp.NUM_LIGNE = Numeric.sequence("s1",1,1) ;
produit = produit_tmp;
// ###############################
...
if(produit != null) { 
    ...
    Operator_tFilterRow_1 ope_tFilterRow_1 = new Operator_tFilterRow_1("&&");
      ope_tFilterRow_1.matches((// code sample : use produit to define the condition.
// produit.columnName1.equals("foo") ||!(produit.columnName2.equals("bar"))
// replace the following expression by your own filter condition 
!produit.CD_PRODUIT.isEmpty()&& !produit.NOM_PRODUIT.isEmpty() &&  !produit.CD_SOUS_CATEGORIE.isEmpty()
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(row2 == null){ 
               ...
               row2.CD_PRODUIT = produit.CD_PRODUIT;
               row2.NOM_PRODUIT = produit.NOM_PRODUIT;
               row2.PRIX_ACHAT_PRODUIT = produit.PRIX_ACHAT_PRODUIT;
               row2.PRIX_VENTE_PRODUIT = produit.PRIX_VENTE_PRODUIT;
               row2.CD_SOUS_CATEGORIE = produit.CD_SOUS_CATEGORIE;
               row2.NUM_LIGNE = produit.NUM_LIGNE;    
      nb_line_ok_tFilterRow_1++;
    } else {
            if (row5 == null){
              row5 = new row5Struct();
            }
                row5.CD_PRODUIT = produit.CD_PRODUIT;
                row5.NOM_PRODUIT = produit.NOM_PRODUIT;
                row5.PRIX_ACHAT_PRODUIT = produit.PRIX_ACHAT_PRODUIT;
                row5.PRIX_VENTE_PRODUIT = produit.PRIX_VENTE_PRODUIT;
                row5.CD_SOUS_CATEGORIE = produit.CD_SOUS_CATEGORIE;
                row5.NUM_LIGNE = produit.NUM_LIGNE;
 					    ...
 					    boolean forceLooprow7 = false;
 							...
 							row7Struct row7ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_5 = false;
                        		    		    ...
                        		    		    row7HashKey.CD_SOUS_CATEGORIE = row3.CD_SOUS_CATEGORIE ;
...
produits = null;
sousCategorieManquante = null;

if(!rejectedInnerJoin_tMap_5 ) {

// # Output table : 'produits'
produits_tmp.CD_PRODUIT = row3.CD_PRODUIT ;
produits_tmp.NOM_PRODUIT = row3.NOM_PRODUIT ;
produits_tmp.PRIX_ACHAT_PRODUIT = row3.PRIX_ACHAT_PRODUIT ;
produits_tmp.PRIX_VENTE_PRODUIT = row3.PRIX_VENTE_PRODUIT ;
produits_tmp.CD_SOUS_CATEGORIE = row3.CD_SOUS_CATEGORIE ;
produits = produits_tmp;

// # Output table : 'sousCategorieManquante'
sousCategorieManquante_tmp.LB_CHEMIN_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILEPATH"));
sousCategorieManquante_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
sousCategorieManquante_tmp.NUM_LIGNE_REJET =  row3.NUM_LIGNE ;
sousCategorieManquante_tmp.LB_LIGNE_REJET = row3.CD_PRODUIT+"|"+row3.NOM_PRODUIT ;
sousCategorieManquante_tmp.LB_MESSAGE_REJET = "Sous categorie Manquante "+row3.CD_SOUS_CATEGORIE ;
sousCategorieManquante_tmp.LB_NOM_FLUX = ((String)globalMap.get("nom_flux"));
sousCategorieManquante_tmp.DT_REJET = TalendDate.getCurrentDate() ;
sousCategorieManquante_tmp.LB_JOB_NAME = jobName;
sousCategorieManquante = sousCategorieManquante_tmp;
...
insertNewProduit_tmp.LB_NOM_FICHIER = ((String)globalMap.get("tFileList_1_CURRENT_FILE"));
insertNewProduit_tmp.DT_INSERTION = TalendDate.getCurrentDate();
insertNewProduit_tmp.BL_LIGNE_ACTIVE = 1;
insertNewProduit_tmp.LB_JOB_NAME = jobName;
...
updateProduit_tmp.CD_PRODUIT = produits.CD_PRODUIT ;
...
updateProduit_tmp.LB_NOM_FICHIER = null;
...
} else {pstmt_tDBOutput_3.setString(1, InsertProduit.CD_PRODUIT);
}

                    if(InsertProduit.NOM_PRODUIT == null) {
pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(2, InsertProduit.NOM_PRODUIT);
}

                    pstmt_tDBOutput_3.setBigDecimal(3, InsertProduit.PRIX_ACHAT_PRODUIT);

                    pstmt_tDBOutput_3.setBigDecimal(4, InsertProduit.PRIX_VENTE_PRODUIT);

                    if(InsertProduit.CD_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_3.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(5, InsertProduit.CD_SOUS_CATEGORIE);
}

                    if(InsertProduit.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_3.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(6, InsertProduit.LB_NOM_FICHIER);
}

                    if(InsertProduit.DT_INSERTION != null) {
pstmt_tDBOutput_3.setTimestamp(7, new java.sql.Timestamp(InsertProduit.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_3.setNull(7, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_3.setInt(8, InsertProduit.BL_LIGNE_ACTIVE);

                    if(InsertProduit.LB_JOB_NAME == null) {
pstmt_tDBOutput_3.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_3.setString(9, InsertProduit.LB_JOB_NAME);
}
...
} else {pstmt_tDBOutput_4.setString(1, insertNewProduit.CD_PRODUIT);
}

                    if(insertNewProduit.NOM_PRODUIT == null) {
pstmt_tDBOutput_4.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(2, insertNewProduit.NOM_PRODUIT);
}

                    pstmt_tDBOutput_4.setBigDecimal(3, insertNewProduit.PRIX_ACHAT_PRODUIT);

                    pstmt_tDBOutput_4.setBigDecimal(4, insertNewProduit.PRIX_VENTE_PRODUIT);

                    if(insertNewProduit.CD_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_4.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(5, insertNewProduit.CD_SOUS_CATEGORIE);
}

                    if(insertNewProduit.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_4.setNull(6, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(6, insertNewProduit.LB_NOM_FICHIER);
}

                    if(insertNewProduit.DT_INSERTION != null) {
pstmt_tDBOutput_4.setTimestamp(7, new java.sql.Timestamp(insertNewProduit.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_4.setNull(7, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_4.setInt(8, insertNewProduit.BL_LIGNE_ACTIVE);

                    if(insertNewProduit.LB_JOB_NAME == null) {
pstmt_tDBOutput_4.setNull(9, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_4.setString(9, insertNewProduit.LB_JOB_NAME);
}
...
} else {pstmt_tDBOutput_5.setString(1, updateProduit.NOM_PRODUIT);
}

                    pstmt_tDBOutput_5.setBigDecimal(2, updateProduit.PRIX_ACHAT_PRODUIT);

                    pstmt_tDBOutput_5.setBigDecimal(3, updateProduit.PRIX_VENTE_PRODUIT);

                    if(updateProduit.CD_SOUS_CATEGORIE == null) {
pstmt_tDBOutput_5.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(4, updateProduit.CD_SOUS_CATEGORIE);
}

                    if(updateProduit.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_5.setNull(5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(5, updateProduit.LB_NOM_FICHIER);
}

                    if(updateProduit.DT_INSERTION != null) {
pstmt_tDBOutput_5.setTimestamp(6, new java.sql.Timestamp(updateProduit.DT_INSERTION.getTime()));
} else {
pstmt_tDBOutput_5.setNull(6, java.sql.Types.TIMESTAMP);
}

                    pstmt_tDBOutput_5.setInt(7, updateProduit.BL_LIGNE_ACTIVE);

                    if(updateProduit.LB_JOB_NAME == null) {
pstmt_tDBOutput_5.setNull(8, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(8, updateProduit.LB_JOB_NAME);
}

                    if(updateProduit.CD_PRODUIT == null) {
pstmt_tDBOutput_5.setNull(9 + count_tDBOutput_5, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_5.setString(9 + count_tDBOutput_5, updateProduit.CD_PRODUIT);
}
...
// Start of branch "sousCategorieManquante"
if(sousCategorieManquante != null) { 
	...
	currentComponent="tDBOutput_6";
        ...
        whetherReject_tDBOutput_6 = false;
                    if(sousCategorieManquante.LB_CHEMIN_FICHIER == null) {
pstmt_tDBOutput_6.setNull(1, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(1, sousCategorieManquante.LB_CHEMIN_FICHIER);
}

                    if(sousCategorieManquante.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_6.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(2, sousCategorieManquante.LB_NOM_FICHIER);
}

                    pstmt_tDBOutput_6.setInt(3, sousCategorieManquante.NUM_LIGNE_REJET);

                    if(sousCategorieManquante.LB_LIGNE_REJET == null) {
pstmt_tDBOutput_6.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_6.setString(4, sousCategorieManquante.LB_LIGNE_REJET);
}
            ...
            if(checkCount_tDBOutput_6 > 0) {
                        if(sousCategorieManquante.LB_MESSAGE_REJET == null) {
pstmtUpdate_tDBOutput_6.setNull(1, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_6.setString(1, sousCategorieManquante.LB_MESSAGE_REJET);
}

                        if(sousCategorieManquante.LB_NOM_FLUX == null) {
pstmtUpdate_tDBOutput_6.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_6.setString(2, sousCategorieManquante.LB_NOM_FLUX);
}

                        if(sousCategorieManquante.DT_REJET != null) {
pstmtUpdate_tDBOutput_6.setTimestamp(3, new java.sql.Timestamp(sousCategorieManquante.DT_REJET.getTime()));
} else {
pstmtUpdate_tDBOutput_6.setNull(3, java.sql.Types.TIMESTAMP);
}

                        if(sousCategorieManquante.LB_JOB_NAME == null) {
pstmtUpdate_tDBOutput_6.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_6.setString(4, sousCategorieManquante.LB_JOB_NAME);
}

                        if(sousCategorieManquante.LB_CHEMIN_FICHIER == null) {
pstmtUpdate_tDBOutput_6.setNull(5 + count_tDBOutput_6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_6.setString(5 + count_tDBOutput_6, sousCategorieManquante.LB_CHEMIN_FICHIER);
}

                        if(sousCategorieManquante.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_6.setNull(6 + count_tDBOutput_6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_6.setString(6 + count_tDBOutput_6, sousCategorieManquante.LB_NOM_FICHIER);
}

                        pstmtUpdate_tDBOutput_6.setInt(7 + count_tDBOutput_6, sousCategorieManquante.NUM_LIGNE_REJET);

                        if(sousCategorieManquante.LB_LIGNE_REJET == null) {
pstmtUpdate_tDBOutput_6.setNull(8 + count_tDBOutput_6, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_6.setString(8 + count_tDBOutput_6, sousCategorieManquante.LB_LIGNE_REJET);
}
...
} else {pstmtInsert_tDBOutput_6.setString(1, sousCategorieManquante.LB_CHEMIN_FICHIER);
}

                        if(sousCategorieManquante.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_6.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_6.setString(2, sousCategorieManquante.LB_NOM_FICHIER);
}

                        pstmtInsert_tDBOutput_6.setInt(3, sousCategorieManquante.NUM_LIGNE_REJET);

                        if(sousCategorieManquante.LB_LIGNE_REJET == null) {
pstmtInsert_tDBOutput_6.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_6.setString(4, sousCategorieManquante.LB_LIGNE_REJET);
}

                        if(sousCategorieManquante.LB_MESSAGE_REJET == null) {
pstmtInsert_tDBOutput_6.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_6.setString(5, sousCategorieManquante.LB_MESSAGE_REJET);
}

                        if(sousCategorieManquante.LB_NOM_FLUX == null) {
pstmtInsert_tDBOutput_6.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_6.setString(6, sousCategorieManquante.LB_NOM_FLUX);
}

                        if(sousCategorieManquante.DT_REJET != null) {
pstmtInsert_tDBOutput_6.setTimestamp(7, new java.sql.Timestamp(sousCategorieManquante.DT_REJET.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_6.setString(8, sousCategorieManquante.LB_JOB_NAME);
}
...
} // End of branch "sousCategorieManquante"
...
insertDuplicate_tmp.LB_LIGNE_REJET = row6.CD_PRODUIT+"|"+row6.NOM_PRODUIT ;
...
} else {pstmt_tDBOutput_2.setString(1, insertDuplicate.LB_CHEMIN_FICHIER);
}

                    if(insertDuplicate.LB_NOM_FICHIER == null) {
pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(2, insertDuplicate.LB_NOM_FICHIER);
}

                    pstmt_tDBOutput_2.setInt(3, insertDuplicate.NUM_LIGNE_REJET);

                    if(insertDuplicate.LB_LIGNE_REJET == null) {
pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmt_tDBOutput_2.setString(4, insertDuplicate.LB_LIGNE_REJET);
}
...
} else {pstmtUpdate_tDBOutput_2.setString(1, insertDuplicate.LB_MESSAGE_REJET);
}

                        if(insertDuplicate.LB_NOM_FLUX == null) {
pstmtUpdate_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(2, insertDuplicate.LB_NOM_FLUX);
}

                        if(insertDuplicate.DT_REJET != null) {
pstmtUpdate_tDBOutput_2.setTimestamp(3, new java.sql.Timestamp(insertDuplicate.DT_REJET.getTime()));
} else {
...
} else {pstmtUpdate_tDBOutput_2.setString(4, insertDuplicate.LB_JOB_NAME);
}

                        if(insertDuplicate.LB_CHEMIN_FICHIER == null) {
pstmtUpdate_tDBOutput_2.setNull(5 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(5 + count_tDBOutput_2, insertDuplicate.LB_CHEMIN_FICHIER);
}

                        if(insertDuplicate.LB_NOM_FICHIER == null) {
pstmtUpdate_tDBOutput_2.setNull(6 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(6 + count_tDBOutput_2, insertDuplicate.LB_NOM_FICHIER);
}

                        pstmtUpdate_tDBOutput_2.setInt(7 + count_tDBOutput_2, insertDuplicate.NUM_LIGNE_REJET);

                        if(insertDuplicate.LB_LIGNE_REJET == null) {
pstmtUpdate_tDBOutput_2.setNull(8 + count_tDBOutput_2, java.sql.Types.VARCHAR);
} else {pstmtUpdate_tDBOutput_2.setString(8 + count_tDBOutput_2, insertDuplicate.LB_LIGNE_REJET);
}
...
} else {pstmtInsert_tDBOutput_2.setString(1, insertDuplicate.LB_CHEMIN_FICHIER);
}

                        if(insertDuplicate.LB_NOM_FICHIER == null) {
pstmtInsert_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(2, insertDuplicate.LB_NOM_FICHIER);
}

                        pstmtInsert_tDBOutput_2.setInt(3, insertDuplicate.NUM_LIGNE_REJET);

                        if(insertDuplicate.LB_LIGNE_REJET == null) {
pstmtInsert_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(4, insertDuplicate.LB_LIGNE_REJET);
}

                        if(insertDuplicate.LB_MESSAGE_REJET == null) {
pstmtInsert_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(5, insertDuplicate.LB_MESSAGE_REJET);
}

                        if(insertDuplicate.LB_NOM_FLUX == null) {
pstmtInsert_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
} else {pstmtInsert_tDBOutput_2.setString(6, insertDuplicate.LB_NOM_FLUX);
}

                        if(insertDuplicate.DT_REJET != null) {
pstmtInsert_tDBOutput_2.setTimestamp(7, new java.sql.Timestamp(insertDuplicate.DT_REJET.getTime()));
} else {
...
} else {pstmtInsert_tDBOutput_2.setString(8, insertDuplicate.LB_JOB_NAME);
}
...
insertReject_tmp.LB_LIGNE_REJET = row5.CD_PRODUIT+"|"+row5.NOM_PRODUIT ;
 ...
 */
	...
	nb_line_rejected_tDBOutput_6=nb_line_rejected_tDBOutput_6 + rejectedCount_tDBOutput_6;
        ...
        globalMap.put("tDBOutput_6_NB_LINE_REJECTED", nb_line_rejected_tDBOutput_6);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"sousCategorieManquante");
			  	}
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row7";
		...
		int tos_count_tAdvancedHash_row7 = 0;
			   		...
			   		// linked node: tMap_5 - inputs:(row3,row7) outputs:(produits,sousCategorieManquante)
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// linked node: tMap_4 - inputs:(produits,row4) outputs:(InsertProduit,insertNewProduit,updateProduit)
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = jODSProduit.class.getClassLoader().getResourceAsStream("k_commerce_reporting/jodsproduit_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     415092 characters generated by Talend Open Studio for Data Integration 
